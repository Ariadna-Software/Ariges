...
Begin VB.Form frmGesSocAsociados 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button10 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Actualizar asociado en seccion"
            Object.Tag             =   "2"
         EndProperty
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmGesSocAsociados.frx":000C
      ...
      Tab(0).Control(8)=   "Label1(25)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "ImgMail(0)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "Label1(3)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "imgFecha(1)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "Label1(16)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "imgFecha(0)"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "Label1(5)"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "imgFecha(2)"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Label1(40)"
      ...
      Begin VB.CheckBox Check1 
         Caption         =   "Se le enviaran habitualmente los comunicados de la Cooperativa"
         Height          =   255
         Index           =   0
         Left            =   -74640
         TabIndex        =   83
      ...
      Begin VB.TextBox txtHco 
         ...
         TabIndex        =   75
         Text            =   "frmGesSocAsociados.frx":0060
         Top             =   5160
         Width           =   3855
      End
      Begin VB.TextBox txtHco 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   72
         Text            =   "frmGesSocAsociados.frx":0066
         Top             =   2280
         Width           =   4215
      End
      ...
      Begin VB.TextBox Text1 
         ...
         Text            =   "frmGesSocAsociados.frx":006C
         Top             =   2040
         Width           =   4380
      End
      Begin VB.TextBox Text1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmGesSocAsociados.frx":0072
         Height          =   1815
         Left            =   480
         TabIndex        =   58
         Top             =   5880
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmGesSocAsociados.frx":0087
         Height          =   5535
         Left            =   -74880
         TabIndex        =   71
         Top             =   2160
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   6720
         Picture         =   "frmGesSocAsociados.frx":009C
         Tag             =   "-1"
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   9360
         Picture         =   "frmGesSocAsociados.frx":019E
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   0
         Left            =   4080
         Picture         =   "frmGesSocAsociados.frx":0229
         ToolTipText     =   "Buscar fecha"
         Top             =   3600
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   1
         Left            =   6720
         Picture         =   "frmGesSocAsociados.frx":02B4
         ToolTipText     =   "Buscar fecha"
         Top             =   1080
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   840
         Picture         =   "frmGesSocAsociados.frx":033F
         Tag             =   "-1"
         ToolTipText     =   "Buscar población"
         Top             =   1567
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmGesSocAsociados"
...
Private WithEvents frmB1 As frmBuscaGrid 'Form para busquedas
...
Dim EsBusqueda As Boolean
    ...
    b = (Modo = 2 Or Modo = 5 Or Modo = 0 Or Modo = 1) And Not EsBusqueda
    'Insertar
    Toolbar1.Buttons(5).Enabled = b
    Me.mnNuevo.Enabled = b
    
    b = (Modo = 2 Or Modo = 5) And Not EsBusqueda
    'Modificar
...
'-- Tipos de IVA (NN: Hay que cargar ahora de la conta que corresonda)
    ...
    CadenaConsulta = "SELECT * FROM conta" & CadenaConsulta & ".tiposiva"
    miRsAux.Open CadenaConsulta, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
...
Dim I As Integer
    ...
    If EsNuevo Then
        ...
        Else
            ...
            miSQL = "Select * from conta" & miRsAux!empresa_conta & ".empresa"
