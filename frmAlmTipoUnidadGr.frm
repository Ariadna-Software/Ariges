...
Begin VB.Form frmAlmTipoUnidadGr 
   ...
   ClientTop       =   330
   ClientWidth     =   6315
   Icon            =   "frmAlmTipoUnidadGr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7470
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmTipoUnidadGr.frx":000C
      Height          =   885
      Left            =   120
      TabIndex        =   15
      TabStop         =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmAlmTipoUnidadGr.frx":0021
      Height          =   2205
      Left            =   120
      TabIndex        =   17
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAlmTipoUnidadGr"
