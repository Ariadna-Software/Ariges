...
Begin VB.Form frmRepEntReparacionesGR 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame3 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "Motivo Pendiente Reparación"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   9.75
               Charset         =   0
...
Private WithEvents frmCli As frmBasico2 'frmFacClientesGr 'Form Mantenimiento Clientesº
Attribute frmCli.VB_VarHelpID = -1
Private WithEvents frmNSeries As frmBasico2 'frmRepNumSerie2GR 'Form Mantenimiento Nº Series
Attribute frmNSeries.VB_VarHelpID = -1
Private WithEvents frmNSeries2 As frmRepNumSerie2GR 'Form Mantenimiento Nº Series
...
Private Sub AbrirForm_CentroCoste()
    ...
    If vParamAplic.ContabilidadNueva Then
        frmB2.vCampos = "Codigo|ccoste|codccost|T||20·Descripción|ccoste|nomccost|T||70·"
        frmB2.vTabla = "ccoste"
    Else
...
'--    'Si es hco aparecen el técnico de la reparacion
...
'++
    ...
    'MONIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    ' Para que comentas.
    ' Si no estan visible , tienen tag, y los campos solo estan schrep !!!!
...
Dim B As Boolean
    ...
    If Modo = 3 Then
        ...
        If CadenaSQL <> "" Then
            MsgBox "El artículo-nºserie ya esta reparandose: " & Text1(1).Text & " / " & Text1(0).Text, vbExclamation
            CadenaSQL = ""
            Exit Function
        End If
    End If
    ...
    If Not RS.EOF Then
        ...
        If Modo = 3 Then
            ...
            If EnGarantia Then
                ...
                Sql = "El equipo esta en garantía. Finaliza el " & Text2(3).Text
                MsgBox Sql, vbInformation
            Else
                'NO esta en garantia
                Sql = String(70, "*") & vbCrLf
                Sql = Sql & vbCrLf & "El equipo NO esta en garantía. Finalizó el " & Text2(3).Text & vbCrLf & vbCrLf & Sql
        ...
        If Sql <> "" Then
            If InsertarRepar(Sql, vTipoMov) Then
                ...
                If InstalacionEsEulerTaxco Then
                    ...
                    'Hay que añadir, aunque sea vacio en scarepeu  que lleva los datos de la ficha tecnica
                    ActualizaBDFicha
                End If
...
Dim i As Byte
    ...
    vDataGrid.Columns(1).visible = False
        ...
        vDataGrid.Columns(4).Caption = "Descripción"
        ...
        Case 3 'CANTIDAD
            If PonerFormatoDecimal(txtAux(Index), 1) Then  'Tipo 1: Decimal(12,2)
                ...
                If (Modo = 5 And ModificaLineas = 1) Then 'Modo Insertar en Mto Lineas
                    ...
                    If Text2(3).Text <> "" Then   'añadido el 18 de diciembre
                        If EsFechaPosterior(Text1(3).Text, Text2(3).Text, False) Then
                           If MsgBox("El aparato esta en Garantía.¿Facturar la linea de Reparacion?", vbQuestion + vbYesNo) = vbNo Then
                                txtAux(4).Text = "0,00"
                                txtAux(5).Text = "0,00"
                                txtAux(6).Text = "0,00"
                                Set vCStock = Nothing
                    ...
                    If Text2(4).Text <> "" Then
                        If MsgBox("El aparato tiene Mantenimiento.¿Facturar la linea de Reparación?", vbQuestion + vbYesNo) = vbNo Then
                            txtAux(4).Text = "0,00"
                            txtAux(5).Text = "0,00"
                            txtAux(6).Text = "0,00"
                            Set vCStock = Nothing
