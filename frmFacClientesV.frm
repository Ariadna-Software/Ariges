...
Begin VB.Form frmFacClientesV 
   ...
   Begin VB.Frame FrameBotonGnral2 
      ...
      Begin MSComctlLib.Toolbar Toolbar5 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            NumButtons      =   1
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Traer datos clientes portenciales"
            EndProperty
         EndProperty
      End
   End
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   200
      TabIndex        =   7
      Tag             =   "Teléfono|T|S|||sclvar|observa||N|"
      Text            =   "Text1"
      Top             =   3930
      Width           =   7395
   End
...
'    End With
    ...
    With Me.Toolbar5
        ...
        .DisabledImageList = frmPpal.imgListComun_BN2
        .ImageList = frmPpal.ImgListComun2
        .Buttons(1).Image = 45 ' Potenciales
    End With
    ...
    If vParamAplic.ManipuladorFitosanitarios2 Then
        Me.Height = 7420
        Frame1.Top = 6040
        Me.cmdAceptar.Top = 6160
    Else
        Me.Height = 6205
        Frame1.Top = 4960
        Me.cmdAceptar.Top = 4960
    End If
...
'        End If
    ...
    AyudaClientesV frmB, Text1(0), cadB, True
    Set frmB = Nothing
...
'            frmListado3.Show vbModal
            frmInformesNew3.OpcionListado = 15
...
Dim Aux As String
    ...
    If CadenaConsulta2 <> "" Then
        ...
        Aux = DevuelveDesdeBD(conAri, "nifclien", "sclipot", "codclien", CadenaConsulta2)
        If Aux = "" Then
        ...
        Aux = Aux & " ,concat('CLIENTE POTENCIAL: ' ,codclien) observa from sclipot where codclien=" & CadenaConsulta2
        
        If ejecutar(Aux, False) Then
            Aux = DevuelveDesdeBD(conAri, "concat(nifclien,'|',nomclien,'|')", "sclipot", "codclien", CadenaConsulta2)
