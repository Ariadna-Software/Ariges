...
Begin VB.Form frmRepEntReparaciones 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.TextBox Text1 
         ...
         Text            =   "frmRepEntReparaciones.frx":009D
         Top             =   5160
         Width           =   8280
      End
      Begin VB.TextBox Text1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmRepEntReparaciones.frx":00A3
         Left            =   -65700
         List            =   "frmRepEntReparaciones.frx":00B0
         Style           =   2  'Dropdown List
         TabIndex        =   30
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   7
            Left            =   1440
            Picture         =   "frmRepEntReparaciones.frx":00CE
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   6
            Left            =   1080
            Picture         =   "frmRepEntReparaciones.frx":01D0
         ...
         Begin VB.Image imgVerAlbaran 
            Height          =   240
            Left            =   9600
            Picture         =   "frmRepEntReparaciones.frx":02D2
            Top             =   2880
            Width           =   240
         End
         Begin VB.Label Label1 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   5
            Left            =   1800
            Picture         =   "frmRepEntReparaciones.frx":0CD4
      ...
      Begin VB.Frame FrameOtros 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   1
            Left            =   1095
            Picture         =   "frmRepEntReparaciones.frx":0DD6
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   0
            Left            =   1095
            Picture         =   "frmRepEntReparaciones.frx":0E61
            ToolTipText     =   "Buscar fecha"
            Top             =   1140
            Width           =   240
         End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   -72600
         Picture         =   "frmRepEntReparaciones.frx":0EEC
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   5
         Left            =   -72600
         Picture         =   "frmRepEntReparaciones.frx":0FEE
         ToolTipText     =   "Buscar fecha"
         Top             =   4680
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   -68920
         Picture         =   "frmRepEntReparaciones.frx":1079
         ToolTipText     =   "Buscar fecha"
         Top             =   1080
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   3
         Left            =   -68920
         Picture         =   "frmRepEntReparaciones.frx":1104
         ToolTipText     =   "Buscar fecha"
         Top             =   1560
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   4
         Left            =   -72600
         Picture         =   "frmRepEntReparaciones.frx":118F
         ToolTipText     =   "Buscar fecha"
         Top             =   3120
         Width           =   240
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   795
         Picture         =   "frmRepEntReparaciones.frx":121A
        ...
        Case 3 'INSERTAR
            If DatosOk Then
                If InsertarCabecera Then
                    'Ficha tecnica
                    If vParamAplic.NumeroInstalacion = 4 Then ActualizaBDFicha
...
Private Sub Form_Load()
    ...
    SSTab1.TabVisible(3) = vParamAplic.NumeroInstalacion = 4
...
Private Sub LimpiarCampos()
    ...
    If vParamAplic.NumeroInstalacion = 4 Then LimpiarFichaTecnica True
...
Dim SQL As String
    ...
    If vParamAplic.NumeroInstalacion = 4 Then conn.Execute "Delete  from scarepeu " & SQL
