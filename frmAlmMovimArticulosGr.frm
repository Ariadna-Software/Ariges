...
Begin VB.Form frmAlmMovimArticulosGr 
   ...
   Icon            =   "frmAlmMovimArticulosGr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   11325
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   0
      Left            =   1980
      Picture         =   "frmAlmMovimArticulosGr.frx":000C
      Tag             =   "-1"
   ...
   Begin VB.Image ImageObservaDFI 
      Height          =   240
      Left            =   8190
      Picture         =   "frmAlmMovimArticulosGr.frx":0A0E
      Top             =   10755
      Visible         =   0   'False
      Width           =   240
   End
   ...
   End
End
Attribute VB_Name = "frmAlmMovimArticulosGr"
