   ...
   Begin VB.Frame FrameBotonGnral2 
      ...
      Begin MSComctlLib.Toolbar Toolbar5 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            EndProperty
            BeginProperty Button4 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Comisión Línea"
            EndProperty
...
Dim Codtipoa As String
    ...
    Me.DataGrid1.visible = cmdObserva3.Tag = 0 Or cmdObserva3.Tag = 1 '++ añadida la segunda condicion con el or
    Me.FrameToolAux2.visible = Me.DataGrid1.visible '++ añadido el toolaux
...
Dim B1 As Boolean
    ...
    Select Case vDataGrid.Name
        Case "DataGrid1" 'Cod. Almacen
            ...
            tots = tots & "S|txtAux(0)|T|Alm|500|;S|txtAux(1)|T|Artículo|2200|;S|txtAux(2)|T|Nombre Artículo|4150|;"
...
Dim i, J As Integer
    ...
    i = Len(vCadena)
    If i > 400 Then
        MsgBox "La cadena supera el máximo de 400 caracteres. Revise.", vbExclamation
        Exit Function
    End If
