...
Begin VB.Form frmAlmPlagas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantenimiento Plagas"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5145
   Icon            =   "frmAlmPlagas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0||splagas|codigopl||S|"
      Text            =   "Dat"
      Top             =   4920
      Width           =   915
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||splagas|nombrepl||N|"
      Text            =   "Dato2"
      Top             =   4920
      Width           =   2115
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmPlagas.frx":000C
      Height          =   4710
      Left            =   150
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAlmPlagas"
...
Dim anc As Single
    ...
    LimpiarCampos
    txtAux(0).Text = SugerirCodigoSiguienteStr("splagas", "codigopl")
...
Private Sub BotonBuscar()
    CargaGrid "codigopl= -1"  'para vaciar los datos del Grid
    'Buscar
    LimpiarCampos
    LLamaLineas 770, 1
    PonerFoco txtAux(0)
...
On Error Resume Next
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla Plagas", vbInformation
...
On Error GoTo Error2
    ...
    'Comprobamos que si se puede borrar
    'Marzo 2013. Ya no esta en el tratamiento. Hay lineas
    'advtrataPlagas
    SQL = DevuelveDesdeBD(conAri, "count(*)", "advtrataPlagas", "codplaga", adodc1.Recordset.Fields(0), "T")
    If SQL = "" Then SQL = "0"
    If Val(SQL) > 0 Then
        MsgBox "Existen registros relacionados en la tabla tratamientos", vbExclamation
        Exit Sub
    End If
    
    
    '### a mano
    SQL = "¿Seguro que desea eliminar la plaga? " & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from splagas where codigopl=" & adodc1.Recordset!codigopl
        conn.Execute SQL
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar plaga", Err.Description
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from splagas "
    CargaGrid
End Sub
...
Private Sub txtAux_LostFocus(Index As Integer)
     ...
     If Index = 0 Then
        If Not PonerFormatoEntero(txtAux(0)) Then txtAux(0).Text = ""
     End If
End Sub
