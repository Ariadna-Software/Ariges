...
Begin VB.Form frmImprimirServ 
   ...
   ClientTop       =   330
   ClientWidth     =   6780
   Icon            =   "frmImprimirServic.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3570
   ...
   End
End
Attribute VB_Name = "frmImprimirServ"
...
Dim cad As String
    ...
    If False Then
        MIPATH = "c:\programas\ariges\informes\"
    End If
...
Dim EsPorEmail As Boolean
    ...
    With frmVisReport
        ...
        .OcultarElMensajeDeError = True
        EnDesarrolloServicioImpresion = False
        .CambiaODBC = CambiaODBC
