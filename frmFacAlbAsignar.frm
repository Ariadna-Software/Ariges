...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Tipo|500|;S|txtAux(1)|T|Numero|950|;S|txtAux(2)|T|Fecha|1000|;S|cmdAux(0)|B||0|;"
    tots = tots & "S|txtAux2(0)|T|Nombre cliente|3400|;S|txtAux(3)|T|Env|700|;S|cmdAux(1)|B||0|;"
    tots = tots & "S|txtAux2(1)|T|Envio|1900|;S|txtAux(4)|T|Zon.|800|;S|cmdAux(2)|B||0|;"
    tots = tots & "S|txtAux2(2)|T|Zona|1900|;S|cmdAux(3)|B||0|;S|txtAux(5)|T|F. Envio|1000|;S|Combo1|C|Doc.|600|;"
    'Mayo 2012. Facturar
    tots = tots & "S|Combo2|C|Fact.|600|;"
...
Dim SQL As String
    ...
    SQL = "select codtipom,numalbar,fechaalb,nomclien,scaalb.codenvio,nomenvio,scaalb.codzonas,"
    SQL = SQL & "nomzonas,fecenvio,if(docarchiv=1,""SI"","""") docarchiv,if(factursn=0,""NO"","""") factursn"
...
Dim anc As Single
    ...
    txtAux(5).Text = DBLet(DataGrid1.Columns(8).Text, "F")
