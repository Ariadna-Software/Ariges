...
Begin VB.Form frmAlmUbicacionesGr 
   ...
   ClientTop       =   30
   ClientWidth     =   6450
   Icon            =   "frmAlmUbicacionesGr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7605
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmUbicacionesGr.frx":000C
      Height          =   5985
      Left            =   90
      TabIndex        =   9
      Top             =   855
   ...
   End
End
Attribute VB_Name = "frmAlmUbicacionesGr"
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Codigo|1200|;S|txtAux(1)|T|Nombre|4430|;"
