...
Dim ObtenerContador As Boolean
    ...
    If InstalacionEsEulerTaxco Then
        ...
        'Mayo 2021
        'El numpedV lo pondre a NULL, porque no quiero que aparezcan los costes 2 veces
        vSQL = vSQL & " , numpedV  = NULL "
...
'        ComprobarNSeriesLineas (NumAlb)
        ...
        Else
            ...
            TraspasoAlbaranesFacturas Precio, CadenaSQL, FechaAlb, CtaBancoPropi, Nothing, lblIndicador, ImprimeFactura, SQL, "", 1, True, False, False, False
        End If
