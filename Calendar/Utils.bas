...
Public Function FormatTimeDuration(ByVal nMinutes As Long, ByVal bAprox As Boolean) As String
    ...
    ElseIf (bAprox Or (nMinutes Mod (24 * 60)) = 0) And nDays > 0 Then
        strDuration = nDays & " dias" & IIf(nDays > 1, "s", "")
...
Public Sub FillStandardDurations_0m_2w(cmbDuration As ComboBox, bSnoozeBox As Boolean)
    ...
    If Not bSnoozeBox Then
        cmbDuration.AddItem "0 minutos"
        cmbDuration.AddItem "1 minuto"
    End If
    
    cmbDuration.AddItem "5 minutos"
    cmbDuration.AddItem "10 minutos"
    cmbDuration.AddItem "15 minutos"
    cmbDuration.AddItem "30 minutos"
    
    cmbDuration.AddItem "1 hora"
    cmbDuration.AddItem "2 horas"
    cmbDuration.AddItem "4 horas"
    cmbDuration.AddItem "8 horas"
    
    cmbDuration.AddItem "0.5 day"
    cmbDuration.AddItem "1 dia"
    cmbDuration.AddItem "2 dias"
    cmbDuration.AddItem "3 dias"
    cmbDuration.AddItem "4 dias"
    
    cmbDuration.AddItem "1 semana"
    cmbDuration.AddItem "2 semanas"
End Sub
...
'
'    '---- Laura: 17/10/2006
'    cad = "DRIVER={MySQL ODBC 3.51 Driver};DESC=;DATA SOURCE= ;DATABASE=" & vUsu.CadenaConexion '& ";SERVER=" & vConfig.SERVER
