...
Begin VB.Form frmMainCalendar 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Dia vista"
            ImageIndex      =   1
            Style           =   2
         EndProperty
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Semana laboral vista"
            ImageIndex      =   2
            Style           =   2
         EndProperty
         BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Semana vista"
            ImageIndex      =   3
            Style           =   2
         EndProperty
         BeginProperty Button4 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Mes vista"
            ImageIndex      =   4
            Style           =   2
         EndProperty
         ...
         BeginProperty Button14 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Configuración impresión"
            ImageIndex      =   5
         EndProperty
         BeginProperty Button15 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Previsualizar"
            ImageIndex      =   6
         EndProperty
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":000C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":055E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":0AB0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":1002
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":1554
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":172E
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":1908
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainCalendar.frx":1AE2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnuCalendar 
      ...
      Begin VB.Menu mnuSeparator2 
         ...
         Visible         =   0   'False
      End
      Begin VB.Menu mnuEnableTheme2007_2 
         Caption         =   "Skin Office 2007 "
         Visible         =   0   'False
      End
      Begin VB.Menu mnuCustomizeTheme2007 
         Caption         =   "Personalizar skin Office 2007 "
         Visible         =   0   'False
      End
   ...
   End
End
Attribute VB_Name = "frmMainCalendar"
...
'Drag Drop
Private miDragDrop As Byte

Public Skin2007 As Boolean


Dim PrimeraVez  As Boolean
Public CambioConfiguracion As Boolean
...
Dim I As Integer
    ...
    Then
        ...
        Else
            ...
            If Not OpParams.DraggingEvent.AllDayEvent And OpParams.DraggingEvent.Label > 0 Then
                
                miDragDrop = 1
                'CalendarControl.Drag 0
                'MsgBox "Cita asociada ", vbExclamation
                CancelOperation = True
            End If
        End If
    ...
    Else
        'DAVID###
        'Si la cita esta asociada tampoco podemos eliminarla
        
        If OpParams.Operation = xtpCalendarEO_DeleteEvent Or OpParams.Operation = xtpCalendarEO_DeleteSelectedEvents Then
            'Es eliminar cita
            'Con lo cual vere si no esta asociada;:
            
            miDragDrop = 0
            For I = 1 To OpParams.EventViews.Count
                If OpParams.EventViews.ViewEvent(I - 1).Event.Label > 0 Then
                    'EsTA ASOCIADA ha ariges
                    miDragDrop = 1
                    Exit For
                End If
            Next I
            
            If miDragDrop > 0 Then
                If Not EliminarCitasAsociadas Then
                    CancelOperation = True
                End If
...
Private Sub CalendarControl_GetItemText(ByVal Params As XtremeCalendarControl.CalendarGetItemTextParams)
    ...
    ElseIf Params.Item = xtpCalendarItemText_EventToolTipText Then
        ...
        Params.Text = Params.ViewEvent.Event.Subject & _
                vbCrLf & Params.ViewEvent.Event.Location & vbCrLf & Params.ViewEvent.Event.Body
        If Params.ViewEvent.Event.Label > 0 Then
            Params.Text = Params.Text & vbCrLf
            'De momento solo esta pedido
            Params.Text = Params.Text & "[PEDIDO]: " & Params.ViewEvent.Event.ReminderSoundFile
            
        End If
        Debug.Print Params.Text
...
Private Sub CalendarControl_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If miDragDrop = 1 Then
            MsgBox "Cita asociada con ariges. No puede moverse", vbExclamation
            miDragDrop = 0
    End If
End Sub
...
'
'    If (Not HitTest.ViewEvent Is Nothing) Then
'       Debug.Print "MouseMove. HitTest labelid= "; HitTest.ViewEvent.Event.Label
'    End If
'
'    UpdateToolbar
'
...
Private Sub CalendarControl_PrePopulate(ByVal ViewGroup As XtremeCalendarControl.CalendarViewGroup, ByVal Events As XtremeCalendarControl.CalendarEvents)
    ...
    For Each pEvent In Events
        ...
        If mnuCustomIcons.Checked Then
            ...
            'Estas dos NO dan lugar. No llevamos citas recurrentes
    ...
    If mnuCustomIcons.Checked Then
        ...
        'DAVID
        '----------------------------------------
        'Aqui pondremos los iconos SI "a lugar"
        'El ejemplo esta ahi bajo
...
Private Sub Form_Activate()
    If PrimeraVez Then
        PrimeraVez = False
        Me.Toolbar1.Buttons(CalendarControl.ViewType + 1).Value = tbrPressed
   
        For ModalFormsRunningCounter = 1 To 4
            Debug.Print Me.Toolbar1.Buttons(ModalFormsRunningCounter).Value
            
        Next ModalFormsRunningCounter
...
Private Sub Form_Load()
    ...
    'Aqui pongo los iconos
    LeerConfiguracionCalendar True
   ...
   'Dejo el button correspondiente pulsado
...
Private Sub mnuCustomIcons_Click()
    ...
    If Not mnuCustomIcons.Checked Then
        ...
        objThemeOfice2007.CustomIcons.LoadBitmap App.Path & "\Calendar\Icons\Reminder.bmp", xtpCalendarEventIconIDReminder, xtpImageNormal
        objThemeOfice2007.CustomIcons.LoadBitmap App.Path & "\Calendar\Icons\Occ.bmp", xtpCalendarEventIconIDOccurrence, xtpImageNormal
        objThemeOfice2007.CustomIcons.LoadBitmap App.Path & "\Calendar\Icons\Exc.bmp", xtpCalendarEventIconIDException, xtpImageNormal
        objThemeOfice2007.CustomIcons.LoadBitmap App.Path & "\Calendar\Icons\Private.bmp", xtpCalendarEventIconIDPrivate, xtpImageNormal
...
'        End If
    ...
    If Not bDeleted Then
        ...
        If ContextEvent.Label > 0 Then
            
            'Cita asociada
            If Not EliminarCitasAsociadas Then bDeleted = True
        End If
        
        If Not bDeleted Then CalendarControl.DataProvider.DeleteEvent ContextEvent
    ...
    If objThemeOfice2007 Is Nothing Then
        ...
        If px.CreateAsXML(True, "CalendarThemeOffice2007") Then
            If px.LoadFromFile(App.Path & "\cfgCalendarThemeOffice2007.xml") Then
                frmMainCalendar.CalendarControl.Theme.DoPropExchange px
            End If
        End If
...
'    frmCalendarDataChooser.Show vbModal, frmMainCalendar
'
'    If Not frmCalendarDataChooser.Cancelled Then
'        Screen.MousePointer = vbHourglass
'        frmMainCalendar.OpenProvider frmCalendarDataChooser.ProviderType, frmCalendarDataChooser.ConnectionString, False
'        Screen.MousePointer = vbDefault
'    End If
End Sub
...
Private Sub PonerOpciononesImpresion()
    ' Header ---------------------------------------------------
    
    CalendarControl.PrintOptions.Header.Font.Name = "Verdana"
    CalendarControl.PrintOptions.Header.Font.Bold = True
    CalendarControl.PrintOptions.Header.Font.SIZE = 14
        
    CalendarControl.PrintOptions.Header.TextLeft = ""
    CalendarControl.PrintOptions.Header.TextCenter = ""
    CalendarControl.PrintOptions.Header.TextRight = vEmpresa.nomempre
    
    ' Footer ---------------------------------------------------
    
    'CalendarControl.PrintOptions.Header.Font.Italic = True
    CalendarControl.PrintOptions.Footer.Font.Name = "Verdana"
    CalendarControl.PrintOptions.Footer.TextLeft = "Fecha: " & DateValue(Now)
    CalendarControl.PrintOptions.Footer.TextCenter = "ARIGES - Ariadna Software"
    CalendarControl.PrintOptions.Footer.TextRight = "Hora: " & TimeValue(Now)
    
    CalendarControl.PrintOptions.PrintDateHeader = True
'    If CalendarControl.ViewType = xtpCalendarWorkWeekView Or CalendarControl.ViewType = xtpCalendarWorkWeekView Then
'        CalendarControl.PrintOptions.DateHeaderFont.SIZE = 14
'    Else
'        CalendarControl.PrintOptions.DateHeaderFont.SIZE = 18
'    End If
    CalendarControl.PrintOptions.PrintFrom = CalendarControl.Options.WorkDayStartTime
        
    CalendarControl.PrintOptions.PrintTo = CalendarControl.Options.WorkDayEndTime
...
Private Sub mnuPrintPreview_Click()
    ...
    CalendarControl.PrintPreviewOptions.Title = "Calendarario ARIGES: " + "Softour Sistemas S.L."
...
Dim AntiguoModoOff As Boolean
    
    AntiguoModoOff = Skin2007
    CambioConfiguracion = False
    
    'Formulario settings
    frmSettings.Show vbModal, Me
    
    If CambioConfiguracion Then LeerConfiguracionCalendar False
    
    'Por si acaso hay que repintar
    If AntiguoModoOff <> Skin2007 Then CambiarTEmaTheme2007
...
'Leer y o Guardar configuracion
...
Public Sub LeerConfiguracionCalendar(Leer As Boolean)
...
Dim Valor
    ...
    If Leer Then
            DisableDragging_ForRecurrenceEvents = False
            DisableInPlaceCreateEvents_ForSaSu = True
            ...
            b = GetSetting("C", "AdvancedOptions", "RemindersManEnabled", True)
            CalendarControl.EnableReminders b
                
            b = GetSetting("C", "AdvancedOptions", "Skin2007", True)
            Skin2007 = b

            b = False
            
            Valor = GetSetting("C", "AdvancedOptions", "workweekmask", 62)
            CalendarControl.Options.WorkWeekMask = Valor
            
            Valor = GetSetting("C", "AdvancedOptions", "timescale", 30)
            CalendarControl.DayView.TimeScale = Valor
            
            
        
            b = GetSetting("C", "AdvancedOptions", "MonthViewShowTimeAsClocks", False)
            CalendarControl.Options.MonthViewShowTimeAsClocks = b
            
            
            b = GetSetting("C", "AdvancedOptions", "WeekViewShowTimeAsClocks", False)
            CalendarControl.Options.WeekViewShowTimeAsClocks = b
            
            b = GetSetting("C", "AdvancedOptions", "WeekViewShowEndDate", False)
            CalendarControl.Options.WeekViewShowEndDate = b
            

            b = GetSetting("C", "AdvancedOptions", "MonthViewShowEndDate", False)
            CalendarControl.Options.MonthViewShowEndDate = b
            
            b = GetSetting("C", "AdvancedOptions", "MonthViewCompressWeekendDays", Not False)
            CalendarControl.Options.MonthViewCompressWeekendDays = b
            
            Valor = GetSetting("C", "AdvancedOptions", "WeeksCount", 5)
            CalendarControl.MonthView.WeeksCount = Valor
            
            Valor = GetSetting("C", "AdvancedOptions", "WorkDayStartTime", "8:00:00")
            CalendarControl.Options.WorkDayStartTime = Valor
            
            Valor = GetSetting("C", "AdvancedOptions", "WorkDayEndTime", "19:00:00")
            CalendarControl.Options.WorkDayEndTime = Valor
        
        
            '---------------------------------------------------------------
            
            Valor = GetSetting("C", "AdvancedOptions", "Flags", 0)
            CalendarControl.Options.AdditionalOptionsFlags.Flags = Valor
        
 
           
            Valor = GetSetting("C", "AdvancedOptions", "ViewType", 1)
            CalendarControl.ViewType = Valor
            
            Valor = GetSetting("C", "AdvancedOptions", "ToolTips_Mode", 0)
            frmMainCalendar.ToolTips_Mode = Valor
    ...
    Else
        ...
        b = CalendarControl.IsRemindersEnabled
        SaveSetting "C", "AdvancedOptions", "RemindersManEnabled", b

        
        
        
        Valor = CalendarControl.Options.WorkWeekMask
        SaveSetting "C", "AdvancedOptions", "workweekmask", Valor
        
        Valor = CalendarControl.DayView.TimeScale
        SaveSetting "C", "AdvancedOptions", "timescale", Valor
        
        Valor = CalendarControl.Options.WeekViewShowTimeAsClocks
        SaveSetting "C", "AdvancedOptions", "WeekViewShowTimeAsClocks", Valor
        
        Valor = CalendarControl.Options.WeekViewShowEndDate
        SaveSetting "C", "AdvancedOptions", "WeekViewShowEndDate", Valor
    
        Valor = CalendarControl.Options.MonthViewShowTimeAsClocks
        SaveSetting "C", "AdvancedOptions", "MonthViewShowTimeAsClocks", Valor
        
        Valor = CalendarControl.Options.MonthViewShowEndDate
        SaveSetting "C", "AdvancedOptions", "MonthViewShowEndDate", Valor
    
        Valor = CalendarControl.Options.MonthViewCompressWeekendDays
        SaveSetting "C", "AdvancedOptions", "MonthViewCompressWeekendDays", Valor
        
        Valor = CalendarControl.MonthView.WeeksCount
        SaveSetting "C", "AdvancedOptions", "WeeksCount", Valor
    
        Valor = CalendarControl.Options.WorkDayStartTime
        SaveSetting "C", "AdvancedOptions", "WorkDayStartTime", Valor
        
        Valor = CalendarControl.Options.WorkDayEndTime
        SaveSetting "C", "AdvancedOptions", "WorkDayEndTime", Valor
    
    
    
        '---------------------------------------------------------------
        Valor = CalendarControl.Options.AdditionalOptionsFlags.Flags
        SaveSetting "C", "AdvancedOptions", "Flags", Valor

    
        b = frmMainCalendar.Skin2007
        SaveSetting "C", "AdvancedOptions", "Skin2007", b
    
    
        Valor = CalendarControl.ViewType
        SaveSetting "C", "AdvancedOptions", "ViewType", Valor
        
        Valor = frmMainCalendar.ToolTips_Mode
        SaveSetting "C", "AdvancedOptions", "ToolTips_Mode", Valor
...
Private Function EliminarCitasAsociadas() As Boolean
    MsgBox "Existen citas asociadas a ARIGES. No se pueden eliminar", vbExclamation
    EliminarCitasAsociadas = False
End Function
