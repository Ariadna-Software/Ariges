...
Begin VB.Form frmAlmADR 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|T|N|||sadr|codigoADR||S|"
      Text            =   "Dat"
      Top             =   4920
      Width           =   915
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||sadr|Descripcion||N|"
      Text            =   "Dato2"
      Top             =   4920
      Width           =   2115
   End
...
Private Sub BotonBuscar()
    CargaGrid "codigoADR= -1"  'para vaciar los datos del Grid
    'Buscar
    LimpiarCampos
    LLamaLineas 770, 1
    PonerFoco txtAux(0)
...
On Error Resume Next
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla sadr", vbInformation
...
On Error GoTo Error2
    ...
    'Comprobamos que no esta en ningun articulo
    SQL = DevuelveDesdeBD(conAri, "count(*)", "sartic", "numadr", adodc1.Recordset.Fields(0), "T")
    If SQL = "" Then SQL = "0"
    If Val(SQL) > 0 Then
        MsgBox "Existen registros relacionados en la tabla artículo", vbExclamation
        Exit Sub
    End If
    
    
    '### a mano
    SQL = "¿Seguro que desea eliminar el ADR? " & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from sadr where codigoADR='" & adodc1.Recordset!codigoADR & "'"
        conn.Execute SQL
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar ADR", Err.Description
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from sadr "
    CargaGrid
End Sub
