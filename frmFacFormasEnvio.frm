...
Begin VB.Form frmFacFormasEnvio 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmFacFormasEnvio.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePortexExtra"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Conductores"
      TabPicture(1)   =   "frmFacFormasEnvio.frx":0028
      ...
      TabPicture(2)   =   "frmFacFormasEnvio.frx":0044
      ...
      Begin VB.ComboBox cboDefecto 
         Height          =   330
         Index           =   1
         ItemData        =   "frmFacFormasEnvio.frx":0060
         Left            =   -69000
         List            =   "frmFacFormasEnvio.frx":006A
      ...
      Begin VB.ComboBox cboDefecto 
         Height          =   330
         Index           =   0
         ItemData        =   "frmFacFormasEnvio.frx":0076
         Left            =   -70200
         List            =   "frmFacFormasEnvio.frx":0080
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   2160
         Visible         =   0   'False
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmFacFormasEnvio.frx":008C
      Left            =   5760
      List            =   "frmFacFormasEnvio.frx":0096
      Style           =   2  'Dropdown List
      TabIndex        =   2
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacFormasEnvio.frx":00A2
      Height          =   6345
      Left            =   150
      TabIndex        =   18
      Top             =   840
...
Private Sub mnImprimir_Click()
    ...
    With frmImprimir2
        .cadTabla2 = "senvio"
        .Informe2 = "rFacEnvio.rpt"
        If cadB <> "" Then
            .cadRegSelec = SQL2SF_David(cadB, "senvio|")
        Else
            .cadRegSelec = ""
        End If
        .cadRegActua = Replace(POS2SF(Adodc1, Me), "senvio", "senvio")
        .cadTodosReg = ""
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Código|1050|;S|txtAux(1)|T|Denominación|4157|;S|Combo1|C|Etiquetas|1000|;"
    If vParamAplic.CartaPortes Then
        For i = 1 To 7
            tots = tots & "N||||0|;"
        Next i
...
Dim SQL As String
        ...
        If Cual_ = 0 Or Cual_ = 1 Then
            ...
            If enlaza Then
                ...
                If Not Adodc1.Recordset.EOF Then
                    If Val(DBLet(Adodc1.Recordset!CodEnvio, "N")) >= 0 Then SQL = "codenvio = " & Adodc1.Recordset!CodEnvio
                End If
            
            End If
            SQL = "SELECT    dni  ,nombre  , if(defecto =1,'Si','') defecto,chofer FROM sconductor where " & SQL
        ...
        If Cual_ = 0 Or Cual_ = 2 Then
            ...
            SQL = "SELECT matricula ,titulo ,if(defecto =1,'Si','') defecto,codenvio FROM smatriculas WHERE " & SQL
