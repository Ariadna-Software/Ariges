...
Begin VB.Form frmComEntPedidosSa 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "txtAux(15)"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "txtAux(12)"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "txtAux(13)"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "txtAux(14)"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "txtDesc(0)"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "txtDesc(11)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "txtDesc(10)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "txtDesc(9)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "txtAux(11)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "txtAux(10)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txtAux(9)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "txtAux2(8)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "Text2(16)"
      ...
      Tab(0).Control(16)=   "cmdAux(1)"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "cmdAux(0)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "txtAux(2)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtAux(7)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "txtAux(6)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "txtAux(5)"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "txtAux(4)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "txtAux(3)"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "txtAux(1)"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "txtAux(0)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "DataGrid1"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "imgAmpliaci"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "imgBuscar2(2)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "Label1(53)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "imgBuscar2(1)"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "imgBuscar2(0)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "Label1(52)"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "Label1(51)"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "Line3"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Line2"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "imgBuscar2(11)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "imgBuscar2(10)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "imgBuscar2(9)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "Label1(43)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "Label1(34)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "Label1(29)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "Label1(46)"
      ...
      Begin VB.Image imgBuscar2 
         ...
         Index           =   2
         Left            =   -63840
         Picture         =   "frmComEntPedidosSa.frx":0D28
         ToolTipText     =   "Buscar actuacion"
         Top             =   4440
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgBuscar2 
         ...
         Index           =   1
         Left            =   -61920
         Picture         =   "frmComEntPedidosSa.frx":0E2A
         ToolTipText     =   "Buscar cliente"
         Top             =   3000
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   12
         Left            =   8280
         Picture         =   "frmComEntPedidosSa.frx":14B6
         ToolTipText     =   "Buscar dirección"
         Top             =   2520
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   1
         Left            =   7080
         Picture         =   "frmComEntPedidosSa.frx":15B8
         ToolTipText     =   "Buscar fecha"
         Top             =   2520
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar2 
         ...
         Index           =   9
         Left            =   -63960
         Picture         =   "frmComEntPedidosSa.frx":1847
         ToolTipText     =   "Buscar proveedor varios"
         Top             =   2280
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   11
         Left            =   1080
         Picture         =   "frmComEntPedidosSa.frx":1949
         ToolTipText     =   "Buscar dirección"
         Top             =   2760
         Width           =   240
      End
...
'QUIERE CREAR NUEVO PEDIDO PROVEEDOR
Public AlbaranVenta As String  'TTTFFFFFFFFAAAAAA... TTT Codtipom    FFFFFFFF ddmmaaaa fechaalb    AAAAA(desde la posicion 11, el nºalbaran
...
Dim Aux As String
    ...
    If AlbaranVenta <> "" Then
       txtAux(12).Text = Mid(AlbaranVenta, 1, 3)
       txtAux(14).Text = Mid(AlbaranVenta, 4, 2) & "/" & Mid(AlbaranVenta, 6, 2) & "/" & Mid(AlbaranVenta, 8, 4)
       txtAux(13).Text = Mid(AlbaranVenta, 12)
       PonerDatosAlbaranFacturaEuler True
...
Private Sub PonerForaGrid()
        ...
        If Not Data2.Recordset.EOF Then  '1: Insertar
            'Poner descripcion de ampliacion lineas
            Text2(16).Text = DevuelveDesdeBDNew(conAri, NomTablaLineas, "ampliaci", "numpedpr", Text1(0).Text, "N", , "numlinea", Data2.Recordset!numlinea, "N")
            If vEmpresa.TieneAnalitica Then
                Me.txtAux(8).Text = DBLet(Data2.Recordset!CodCCost, "T")
        ...
        Else
            Text2(16).Text = ""
            If vEmpresa.TieneAnalitica Then Me.txtAux(8).Text = "":                Me.TxtAux2(8).Text = ""
...
Dim b As Boolean
    ...
    b = False
    If Modo = 5 Then
        If ModificaLineas = 1 Or ModificaLineas = 2 Then b = True
    End If
...
'            frmCli.Show vbModal
            ...
            AyudaClientes frmCli, Text1(22).Text
            Set frmCli = Nothing
            If CadenaSQL <> "" Then
...
'            frmCli.Show vbModal
            Set frmCli = New frmBasico2
            AyudaClientes frmCli, txtAux(9).Text
            Set frmCli = Nothing
            If CadenaSQL <> "" Then
...
Dim cad As String
    ...
    If InstalacionEsEulerTaxco Then
        ...
        If txtAux(12).Text = "" And txtAux(15).Text <> "" Then
            Aux = DevuelveDesdeBD(conAri, "codclien", "scaped", "numpedcl", txtAux(15).Text, "N")
            If Val(Aux) <> Val(txtAux(9).Text) Then
                MsgBox "El pedido no pertenece al cliente indicado", vbExclamation
                Exit Function
            End If
        End If
...
On Error GoTo EInsertarLinea
    ...
    If DatosOkLinea() Then 'Lineas de Pedidos
        ...
        SQL = SQL & "(numpedpr,numlinea, codalmac, codartic, nomartic, ampliaci, cantidad, recibida, precioar, dtoline1, dtoline2, importel,codccost,codclien,coddirec,actuacion,codtipomV,numalbarV,fechaalbV,numpedV) "
...
On Error GoTo EModificarLinea
    ...
    If DatosOkLinea() Then
        ...
        If InstalacionEsEulerTaxco Then
            ...
            SQL = SQL & "," & "numpedV=" & DBSet(txtAux(15).Text, "N", "S")
        End If
        ...
        If Not Me.Data2.Recordset.EOF Then
            ...
            If InstalacionEsEulerTaxco Then
                For i = 12 To 15
                    ...
                    BloquearTxt txtAux(i), True
                Next i
                If txtAux(15).Text <> "" Then txtAux(15).Text = Format(txtAux(15).Text, "00000")
                PonerDatosAlbaranFacturaEuler False
            End If
        ...
        Case 15
            ...
            Else
                ...
                Else
                    ...
                    Else
                        If Val(txtAux(9).Text) <> Val(devuelve) Then
                            MsgBox "El pedido no es de el cliente seleccionado:  " & Val(devuelve) & " // " & Val(txtAux(10).Text), vbExclamation
                            txtAux(Index).Text = ""
                        Else
                            txtAux(12).Text = "": txtAux(13).Text = "": txtAux(14).Text = "": txtDesc(0).Text = ""
                        End If
                    End If
                End If
...
Dim TrabAlb As String
    ...
    vSQL = vSQL & " numpedpr, fecpedpr,codenvio,NReferencia,SReferencia,fecentrega,fentrada)"
    ...
    vSQL = vSQL & " ,numpedpr, fecpedpr,codenvio,NReferencia,SReferencia,fecentrega, " & DBSet(RecuperaValor(CadenaSQL, 5), "F")
    ...
    If Not InsertarLineasAlbaran(NumAlb, FechaAlb, RecuperaValor(CadenaSQL, 5)) Then Exit Function
...
Private Function InsertarLineasAlbaran(NumAlb As String, FechaAlb As String, FecEntrada As String) As Boolean
...
On Error GoTo EInsertarLinAlb
        ...
        While Not RS.EOF 'Para cada linea de pedido insertar una de albaran si recibidas >0
            ...
            If AlbCompleto Then
                'Va la linea entera
                SQL2 = "INSERT INTO slialp (numalbar, fechaalb, codprove, numlinea,codartic, codalmac, nomartic, ampliaci, cantidad, precioar, dtoline1, dtoline2, importel,codccost,codclien,coddirec,actuacion,codtipomV,numalbarV, fechaalbV,numpedV ) "
            ...
            If SQL2 <> "" Then
                ...
                'Lleva la fecha de entrada :   FecEntrada   antes FechaAlb
                InsertarMovStock2 NumAlb, FecEntrada, numlinea, cantidad, CCur(ImpLinea), RS!codAlmac, RS!codArtic
...
Private Function InsertarMovStock2(NumAlb As String, FechaMov As String, NLin As Integer, cantidad As Currency, Importe As Currency, codAlmac As Integer, codArtic As String) As Boolean
...
Dim b As Boolean
    ...
    If InstalacionEsEulerTaxco Then
        If b Then
            ...
            Me.txtAux(15).Text = DBLet(Me.Data2.Recordset.Fields(18), "n")
            If txtAux(15).Text <> "" Then txtAux(15).Text = Format(txtAux(15).Text, "00000")
            PonerDatosAlbaranFacturaEuler False
        Else
            txtAux(12).Text = "": txtAux(13).Text = "": txtAux(14).Text = "": txtAux(15).Text = ""
            txtDesc(0).Text = ""
        End If
    End If
...
Dim Euler As Boolean
    ...
    Label1(53).visible = Euler
    
End Sub

Private Sub PonerDatosAlbaranFacturaEuler(DesdeNuevaLinea As Boolean)
Dim cad As String
    ...
    If txtAux(12).Text <> "" And Me.txtAux(13).Text <> "" And Me.txtAux(14).Text <> "" Then
        ...
        If cad = "" Then
            ...
            End If
        Else
            If DesdeNuevaLinea Then
                txtAux(9).Text = Mid(cad, 1, InStr(1, cad, " "))
                txtDesc(9).Text = Trim(Mid(cad, InStr(1, cad, " ")))
            End If
...
Private Sub LanzarBuscarAlbaranEuler(EsPedido As Boolean)
    ...
    frmListado5.OtrosDatos = IIf(EsPedido, "1", "0") & Val(txtAux(9).Text)
    frmListado5.Show vbModal
    FormularioListAlbAbierto = False
    'CadenaDesdeOtroForm ="" esta puesto en el form
    If CadenaDesdeOtroForm <> "" Then
        EsPedido = Mid(CadenaDesdeOtroForm, 1, 1) = "1"
        CadenaDesdeOtroForm = Mid(CadenaDesdeOtroForm, 2)
        If Not EsPedido Then
            ...
            txtAux(14).Text = RecuperaValor(CadenaDesdeOtroForm, 3)
             txtAux_LostFocus 12
        Else
            txtAux(15).Text = RecuperaValor(CadenaDesdeOtroForm, 2)
            txtAux_LostFocus 15
        End If
    End If
End Sub
