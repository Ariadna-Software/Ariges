...
Begin VB.Form frmTelefoniaModelos 
   ...
   ClientTop       =   330
   ClientWidth     =   4620
   Icon            =   "frmTelefoniaModelos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|stfnomodel|codmodelo|0000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||stfnomodel|descripcion||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTelefoniaModelos.frx":000C
      Height          =   4715
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmTelefoniaModelos"
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("stfnomodel", "codmodelo")
...
On Error Resume Next
    ...
    If Adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla stfnomodel", vbInformation
...
On Error GoTo Error2
    ...
    '### a mano
    SQL = "¿Seguro que desea eliminar el modelo?" & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from stfnomodel where codmodelo=" & Adodc1.Recordset!codmodelo
        conn.Execute SQL
        CancelaADODC Adodc1
        CargaGrid ""
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from stfnomodel"
    CargaGrid
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 10   'Imprimir Listado de Modelos
            Me.Hide
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'codmodelo
End Sub
...
Private Function SepuedeBorrar() As Boolean
    ...
    If HayRegParaInforme("sclientfno", "modelo = " & CStr(Me.Adodc1.Recordset!codmodelo), True) Then
        MsgBox "Hay telefonos de clientes de este modelo", vbExclamation
        SepuedeBorrar = False
    Else
        SepuedeBorrar = True
    End If
