...
Begin VB.Form frmObraCapitulo 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantenimiento capítulos"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10800
   Icon            =   "frmObraCapitulo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "frmObraCapitulo.frx":000C
      Left            =   4080
      List            =   "frmObraCapitulo.frx":0016
      Style           =   2  'Dropdown List
      TabIndex        =   10
      Tag             =   "Detall|N|N|||scapitulos|Detallad||N|"
      Top             =   5040
      Width           =   615
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Locked          =   -1  'True
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|scapitulos|codcapit|0000|S|"
      Text            =   "Codi"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   100
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||scapitulos|nomcapit||N|"
      Text            =   "Descripcion"
      Top             =   5040
      Width           =   2835
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmObraCapitulo.frx":0022
      Height          =   4845
      Left            =   120
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmObraCapitulo"
...
Dim anc As Single
    ...
    LimpiarCampos
    txtAux(0).Text = SugerirCodigoSiguienteStr("scapitulos", "codcapit")
...
Dim I As Integer
    ...
    Cad = Adodc1.Recordset.Fields(2)
    If UCase(Cad) = "SI" Then
        Combo1.ListIndex = 0
    Else
        Combo1.ListIndex = 1
    End If
...
Private Sub LLamaLineas(alto As Single, xModo As Byte)
    ...
    Me.Combo1.Left = DataGrid1.Columns(2).Left + 120
End Sub
...
Dim SQL As String
    ...
    '### a mano
    SQL = "¿Seguro que desea eliminar el capitulo? " & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        'Hay que eliminar
        SQL = "Delete from scapitulos where codcapit=" & Adodc1.Recordset!codcapit
        conn.Execute SQL
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select codcapit, nomcapit, if(detallad=1,""Si"",""No"") from scapitulos"
    CargaGrid2
End Sub
...
Dim b As Boolean
    ...
    I = 1 'Desc. Tipo Unidad
        ...
        DataGrid1.Columns(I).Width = 8200
    I = 2 'Desc. Tipo Unidad
        DataGrid1.Columns(I).Caption = "Deta."
    ...
    If Not CadAncho Then
        ...
        Me.Combo1.Width = DataGrid1.Columns(2).Width + 35
        CadAncho = True
    End If
