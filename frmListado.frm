...
Begin VB.Form frmListado 
   ...
   Begin VB.Frame FrameRepxDia 
      ...
      Begin VB.Frame FrameTipMov 
         ...
         Begin VB.ComboBox cboTipMov 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frmListado.frx":0BA3
            Left            =   110
            List            =   "frmListado.frx":0BA5
            Style           =   2  'Dropdown List
            TabIndex        =   183
            Top             =   480
            Width           =   3135
   ...
   Begin VB.Frame FrameInfArticulos 
      ...
      Begin VB.ComboBox cmbDecimales 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmListado.frx":0CBD
         Left            =   600
         List            =   "frmListado.frx":0CCA
         Style           =   2  'Dropdown List
         TabIndex        =   297
         Top             =   6360
         Width           =   1335
      ...
      Begin VB.ComboBox cmbProduccion 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmListado.frx":12FD
         Left            =   2280
         List            =   "frmListado.frx":1307
         Style           =   2  'Dropdown List
         TabIndex        =   618
         Top             =   6360
         Width           =   2415
   ...
   Begin VB.Frame FrameTarifas 
      ...
      Begin VB.ComboBox cboDecimales 
         Height          =   315
         ItemData        =   "frmListado.frx":1856
         Left            =   3240
         List            =   "frmListado.frx":1869
         Style           =   2  'Dropdown List
         TabIndex        =   609
         Top             =   8040
         Width           =   1335
