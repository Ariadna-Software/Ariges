   ...
   Begin VB.Frame FrameInventario 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.ComboBox cboStokFecha 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frmListado.frx":0A5F
            Left            =   120
            List            =   "frmListado.frx":0A6C
            Style           =   2  'Dropdown List
            TabIndex        =   59
            Top             =   1035
            Width           =   975
