...
Begin VB.Form frmTelDtoConsumo 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Descuentos consumo"
   ClientHeight    =   8700
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13965
   ClipControls    =   0   'False
   Icon            =   "frmTelDtoConsumo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8700
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   5
      Tag             =   "% Coop|N|N|0|100.01|tel_desc_consumos|Porcentaje|##0.00||"
      Text            =   "fecha"
      Top             =   4440
      Visible         =   0   'False
      Width           =   1215
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   16
      TabIndex        =   4
      Tag             =   "%Ope|N|N|0|100.01|tel_desc_consumos|PorcentajeOperador|##0.00||"
      Text            =   "zona"
      Top             =   4320
      Visible         =   0   'False
      Width           =   975
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   16
      TabIndex        =   3
      Tag             =   "Grupo|N|N|0||tel_desc_consumos|grupo|0||"
      Text            =   "envio"
      Top             =   4320
      Visible         =   0   'False
      Width           =   1215
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Importe|N|N|0||tel_desc_consumos|Importe|#,##0.00|S|"
      Text            =   "fecha"
      Top             =   4320
      Visible         =   0   'False
      Width           =   1215
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   50
      TabIndex        =   1
      Tag             =   "Desc|T|N|||tel_desc_consumos|DescTipoTrafico|||"
      Text            =   "numlote"
      Top             =   4320
      Visible         =   0   'False
      Width           =   1215
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   16
      TabIndex        =   0
      Tag             =   "codigo|T|N|||tel_desc_consumos|CodTipoTrafico||S|"
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTelDtoConsumo.frx":000C
      Height          =   7065
      Left            =   120
      TabIndex        =   8
      Top             =   915
   ...
   End
End
Attribute VB_Name = "frmTelDtoConsumo"
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    Ordenacion = " ORDER BY CodTipoTrafico,importe "
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Tipo|1700|;S|txtAux(1)|T|Descripcion|3900|;S|txtAux(2)|T|Importe|1450|;"
    tots = tots & "S|txtAux(3))|T|Grupo|800|;S|cmdAux(0)|B||0|;S|txtAux2(0)|T|Nom. grupo|3000|;"
    tots = tots & "S|txtAux(4)|T|%Operador|1230|;S|txtAux(5)|T|% Coop|1000|;"
...
Private Sub mnEliminar_Click()
     '### a mano
    HaDevueltoDatos = "¿Seguro que desea eliminar la linea de descuento? " & vbCrLf
    HaDevueltoDatos = HaDevueltoDatos & vbCrLf & "Código: " & Data1.Recordset.Fields(0)
    HaDevueltoDatos = HaDevueltoDatos & vbCrLf & "Denominación: " & Data1.Recordset.Fields(1)
    HaDevueltoDatos = HaDevueltoDatos & vbCrLf & "Importe: " & Data1.Recordset.Fields(2)
    
    If MsgBox(HaDevueltoDatos, vbQuestion + vbYesNo) = vbYes Then
        'Hay que eliminar
        NumRegElim = Me.Data1.Recordset.AbsolutePosition
        HaDevueltoDatos = "CodTipoTrafico=" & DBSet(Me.Data1.Recordset.Fields(0), "T") & " and Importe=" & TransformaComasPuntos(CStr(Data1.Recordset!Importe))
        HaDevueltoDatos = "Delete from tel_desc_consumos where " & HaDevueltoDatos
        ejecutar HaDevueltoDatos, False
        CancelaADODC Me.Data1
        CargaGrid True
        CancelaADODC Me.Data1
        SituarDataPosicion Me.Data1, NumRegElim, HaDevueltoDatos
    End If
    HaDevueltoDatos = ""
End Sub
...
Private Sub mnNuevo_Click()
    ...
    NumRegElim = Val(ObtenerAlto(DataGrid1, 30))
...
'--------------------------------------------------------------------
Dim SQL As String
    'tel_desc_consumostel_desc_consumos     CodTipoTrafico  Porcentaje Importe Grupo DescTipoTrafico PorcentajeOperador
    SQL = "select CodTipoTrafico,DescTipoTrafico,Importe,tel_desc_consumos.grupo,nombre,PorcentajeOperador,Porcentaje"
    SQL = SQL & " from tel_desc_consumos,tel_desc_nombres_grupo"
    SQL = SQL & " where tel_desc_consumos.Grupo=tel_desc_nombres_grupo.Grupo "
    If enlaza Then
        If EsBusqueda And CadenaBusqueda <> "" Then SQL = SQL & CadenaBusqueda
    Else
        SQL = SQL & " AND  CodTipoTrafico = -1"
    End If
    SQL = SQL & Ordenacion
    MontaSQLCarga = SQL
End Function
...
Dim i As Integer
    ...
    TxtAux2(0).Text = DBLet(DataGrid1.Columns(4).Value, "T")
    For i = 4 To 5
        txtAux(i).Text = DBLet(DataGrid1.Columns(i + 1).Text, "T")
    Next i
...
'        frmB.vCampos = "Codigo|tel_desc_nombres_grupo|grupo|N||20·Decripcion|tel_desc_nombres_grupo|nombre|T||60·"
'        frmB.vSQL = ""
'
'        frmB.vDevuelve = "0|1|"
'
'        frmB.vTitulo = "Nombres de grupo"
'        frmB.vTabla = "tel_desc_nombres_grupo"
'        frmB.vselElem = 0
        ...
        Case 3
            ...
            If txtAux(Index).Text <> "" Then
                ...
                Else
                    ...
                    cad = DevuelveDesdeBD(conAri, "nombre", "tel_desc_nombres_grupo", "grupo", txtAux(Index).Text)
