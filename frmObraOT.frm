...
Begin VB.Form frmObraOT 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantenimiento tipos ordenes de trabajo"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7680
   Icon            =   "frmObraOT.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      Locked          =   -1  'True
      TabIndex        =   0
      Tag             =   "Código|T|N|||stipor|codtipor||S|"
      Text            =   "Codi"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||stipor|nomtipor||N|"
      Text            =   "Descripcion"
      Top             =   5040
      Width           =   2835
   End
