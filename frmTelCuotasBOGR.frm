...
Begin VB.Form frmTelBolbaiteGR 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   8895
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   12495
   Icon            =   "frmTelCuotasBOGR.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8895
   ...
   Begin VB.ComboBox cboOperadora 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmTelCuotasBOGR.frx":000C
      Left            =   1440
      List            =   "frmTelCuotasBOGR.frx":000E
   ...
   Begin VB.ComboBox CboMensual 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmTelCuotasBOGR.frx":0010
      Left            =   3360
      List            =   "frmTelCuotasBOGR.frx":0012
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   4920
      Visible         =   0   'False
   ...
   Begin VB.ComboBox CboAcciones 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmTelCuotasBOGR.frx":0014
      Left            =   2400
      List            =   "frmTelCuotasBOGR.frx":0016
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   4920
      Visible         =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTelCuotasBOGR.frx":0018
      Height          =   7065
      Left            =   120
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmTelBolbaiteGR"
...
'    End With
    ...
    ElseIf QueOpcion = 1 Then
        ...
        Me.txtAux(2).Tag = ""
        Me.CboAcciones.Tag = "accion|N|N|0||@@|accion|0||"
        Me.DataGrid1.Width = 10785 '10995
        Me.txtAux(2).Tag = "Valor|N|N|0|||@@|Valor|#0.0000||"
...
Dim tots As String
    ...
    '### a mano
    If QueOpcion = 0 Then
        tots = "S|txtAux(0)|T|Codigo|1000|;S|txtAux(1)|T|Descripción|5000|;N||||0|;"
        tots = tots & "S|CboAcciones|C|Accion|1900|;N||||0|;S|CboMensual|C|Aplicar|1500|;S|txtAux(2)|T|Valor|1600|;N||||0|;"
        
    ElseIf QueOpcion = 1 Then
        tots = "S|txtAux(0)|T|Codigo|1000|;S|txtAux(1)|T|Descripción|5000|;N||||0|;S|CboMensual|C|Refacturar|1400|;"
        tots = tots & "N||||0|;S|CboAcciones|C|Seguro|1300|;N||||0|;"
    
    ElseIf QueOpcion = 2 Then
        
        tots = "S|txtAux(0)|T|Codigo|1000|;S|txtAux(1)|T|Descripción|5500|;S|txtAux(2)|T|Importe|1400|;N||||0|;"
        
    Else
        'tel_cargo_varios CodigoVario Descripcion CargarEnFactura
        tots = "S|txtAux(0)|T|Codigo|1000|;S|txtAux(1)|T|Descripción|5500|;S|CboMensual|C|Facturar|1400|;N||||0|;N||||0|;"
    End If
        
         
    tots = "S|cboOperadora|C|Operadora|1500|;" & tots
