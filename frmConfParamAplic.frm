   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame FrameOpciones 
         ...
         Begin VB.CheckBox chkVarios 
            Caption         =   "Inventario x código artículo"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   9.75
               Charset         =   0
      ...
      End
      Begin VB.Label Label1 
         Caption         =   "Situación riesgo sin bloqueo"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
            Charset         =   0
      ...
      End
      Begin VB.Label Label1 
         Caption         =   "Situación riesgo con  bloqueo "
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
            Charset         =   0
...
Dim Ayuda As String
    ...
    Case 5, 6
        Ayuda = vbCrLf & " Si marcamos el check de operaciones aseguradas, si supera el riesgo pondrá la siguientes sitauciones:"
...
'            Set frmAc = Nothing
        ...
        Case 29, 65, 79 'Código de Situación
            Me.imgBuscar(1).Tag = Index
