...
Begin VB.Form frmFacEntPedPresu 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Presupuestos.      Pedidos clientes   ******"
   ClientHeight    =   7935
   ClientLeft      =   -150
   ClientTop       =   150
   ClientWidth     =   13455
   Icon            =   "frmFacEntPedPresu.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7935
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   60
         TabIndex        =   9
         Tag             =   "Nombre Cliente|T|N|||scapedB|nomclien||N|"
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   30
         TabIndex        =   8
         Tag             =   "Cod. Cliente|N|N|||scapedB|codclien|000000|N|"
         Text            =   "Text1"
         Top             =   480
         Width           =   780
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   30
         TabIndex        =   7
         Tag             =   "Realizada Por|N|N|0|9999|scapedB|codtraba|0000|N|"
         Text            =   "Text1"
         Top             =   130
         Width           =   660
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   1
         Tag             =   "Fecha Pedido|F|N|||scapedB|fecpedcl|dd/mm/yyyy|N|"
         Top             =   360
         Width           =   1065
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   7
         TabIndex        =   0
         Tag             =   "Nº Pedido|N|S|0||scapedB|numpedcl|0000000|S|"
         Text            =   "Text1 7"
         Top             =   360
         Width           =   885
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   2
         Tag             =   "Fecha Entrega|F|N|||scapedB|fecentre|dd/mm/yyyy|N|"
         Top             =   360
         Width           =   1065
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   3
         Tag             =   "Semana Entrega|N|N|0|52|scapedB|sementre|0|N|"
         Top             =   360
         Width           =   465
      End
      Begin VB.CheckBox chkVisadoRes 
         ...
         Left            =   4440
         TabIndex        =   6
         Tag             =   "Visado Responsable|N|N|||scapedB|visadore||N|"
         Top             =   570
         Width           =   1815
      End
      Begin VB.CheckBox chkRestoPed 
         ...
         Left            =   4440
         TabIndex        =   5
         Tag             =   "Resto de Pedido|N|N|||scapeBB|restoped||N|"
         Top             =   360
         Width           =   1815
      End
      Begin VB.CheckBox chkServirCom 
         ...
         Left            =   4440
         TabIndex        =   4
         Tag             =   "Servir completo|N|N|||scapedB|servcomp||N|"
         Top             =   120
         Width           =   1815
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   7185
         Picture         =   "frmFacEntPedPresu.frx":000C
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   3
         Left            =   7185
         Picture         =   "frmFacEntPedPresu.frx":010E
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   0
         Left            =   2055
         Picture         =   "frmFacEntPedPresu.frx":0210
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   1
         Left            =   3225
         Picture         =   "frmFacEntPedPresu.frx":029B
         ToolTipText     =   "Buscar fecha"
         Top             =   120
         Width           =   240
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmFacEntPedPresu.frx":0326
      ...
      TabPicture(1)   =   "frmFacEntPedPresu.frx":0342
      ...
      Tab(1).Control(10)=   "Text1(25)"
      Tab(1).Control(11)=   "Text1(30)"
      ...
      TabPicture(2)   =   "frmFacEntPedPresu.frx":035E
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   31
         Tag             =   "Observación pedido 1|T|S|||scapedB|observap1||N|"
         Top             =   2760
         Width           =   8805
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   32
         Tag             =   "Observación pedido 2|T|S|||scapedB|observap2||N|"
         Top             =   3060
         Width           =   8805
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   76
         Tag             =   "Fecha Oferta|F|S|||scapedB|fecofert|dd/mm/yyyy|N|"
         Top             =   1035
         Width           =   1185
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   7
         TabIndex        =   75
         Tag             =   "Nº Oferta|N|S|||scapedB|numofert|0000000|N|"
         Text            =   "Text1 7"
         Top             =   1035
         Width           =   885
      End
      ...
      Begin VB.Frame FrameCliente 
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   24
            Tag             =   "Dir envio|N|S|0|999|scapedB|coddiren|000|N|"
            Text            =   "Text1"
            Top             =   1200
            Width           =   540
         End
         Begin VB.CheckBox chkEnviadaConfir 
            ...
            Left            =   10200
            TabIndex        =   133
            Tag             =   "Enviado e-mail confirmación|N|N|||scapedB|envconfir||N|"
            Top             =   1680
            Width           =   2415
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   40
            TabIndex        =   25
            Tag             =   "E-mail confirmación|T|S|||scapedB|mailconfir||N|"
         ...
         Begin VB.CheckBox chkRecogeClien 
            ...
            Left            =   3960
            TabIndex        =   17
            Tag             =   "Recoge cliente|N|N|||scapedB|recogecl||N|"
            Top             =   1560
            Width           =   1455
         End
         Begin VB.TextBox Text2 
            ...
            MaxLength       =   40
            TabIndex        =   72
            Tag             =   "Direccion/Dpto.|T|S|||scapedB|nomdirec||N|"
            Text            =   "Text2"
            Top             =   165
            Width           =   4215
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   21
            Tag             =   "Direccion/Dpto.|N|S|0|999|scapedB|coddirec|000|N|"
            Text            =   "Text1"
            Top             =   165
            Width           =   540
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   15
            Tag             =   "Provincia|T|N|||scapedB|proclien||N|"
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   6
            TabIndex        =   13
            Tag             =   "CPostal|T|N|||scapedB|codpobla||N|"
            Text            =   "Text15"
            Top             =   867
            Width           =   630
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   14
            Tag             =   "Población|T|N|||scapedB|pobclien||N|"
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   20
            TabIndex        =   11
            Tag             =   "teléfono Cliente|T|S|||scapedB|telclien||N|"
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   15
            TabIndex        =   10
            Tag             =   "NIF Cliente|T|N|||scapedB|nifclien||N|"
            Text            =   "123456789"
            Top             =   165
            Width           =   1110
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   20
            TabIndex        =   16
            Tag             =   "Referencia Cliente|T|S|||scapedB|referenc||N|"
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   22
            Tag             =   "Cod. Agente|N|N|0|9999|scapedB|codagent|0000|N|"
            Text            =   "Text1"
            Top             =   480
            Width           =   540
         End
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   30
            TabIndex        =   23
            Tag             =   "Forma de Pago|N|N|0|999|scapedB|codforpa|000|N|"
            Text            =   "Text1"
            Top             =   840
            Width           =   540
         End
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   7
            TabIndex        =   18
            Tag             =   "Descuento P.Pago|N|N|0|99.90|scapedB|dtoppago|#0.00|N|"
            Text            =   "Text1 7"
            Top             =   1935
            Width           =   540
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   7
            TabIndex        =   19
            Tag             =   "Descuento General|N|N|0|99.90|scapedB|dtognral|#0.00|N|"
            Text            =   "Text1 7"
            Top             =   1935
            Width           =   540
         End
         Begin VB.ComboBox cboFacturacion 
            ...
            TabIndex        =   20
            Tag             =   "Tipo Facturación|N|N|||scapedB|tipofact||N|"
            Top             =   1920
            Width           =   1820
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   60
            TabIndex        =   12
            Tag             =   "Domicilio|T|N|||scapedB|domclien||N|"
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   7
            Left            =   7440
            Picture         =   "frmFacEntPedPresu.frx":037A
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   6
            Left            =   900
            Picture         =   "frmFacEntPedPresu.frx":047C
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   2
            Left            =   7440
            Picture         =   "frmFacEntPedPresu.frx":057E
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   1
            Left            =   900
            Picture         =   "frmFacEntPedPresu.frx":0680
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   5
            Left            =   7440
            Picture         =   "frmFacEntPedPresu.frx":0782
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   4
            Left            =   7440
            Picture         =   "frmFacEntPedPresu.frx":0884
            ToolTipText     =   "Buscar forma de pago"
            Top             =   900
            Width           =   240
         End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   30
         Tag             =   "Observación 5|T|S|||scapedB|observa05||N|"
         Top             =   2160
         Width           =   8805
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   29
         Tag             =   "Observación 4|T|S|||scapedB|observa04||N|"
         Top             =   1875
         Width           =   8805
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   28
         Tag             =   "Observación 3|T|S|||scapedB|observa03||N|"
         Top             =   1590
         Width           =   8805
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   27
         Tag             =   "Observación 2|T|S|||scapedB|observa02||N|"
         Top             =   1305
         Width           =   8805
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   80
         TabIndex        =   26
         Tag             =   "Observación 1|T|S|||scapedB|observa01||N|"
         Top             =   1020
         Width           =   8805
      End
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmFacEntPedPresu.frx":0986
         Height          =   2760
         Left            =   195
         TabIndex        =   56
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "frmFacEntPedPresu"
...
Dim AlbCompleto As Boolean 'Si se va a servir el Pedido Completo (slialb.cantidad=slipedb.cantidad)
                            'o se va a servir una parte (slialb.cantidad=slipedb.servidas)
    ...
    Select Case Modo
        ...
        Case 4  'MODIFICAR Cabecera Pedido
         ...
         Case 5 'InsertarModificar LINEA
            'Actualizar el registro en la tabla de lineas 'slipedb'
        ...
        Case 6 'PASAR Pedido a ALBARAN
            'Comprobar que la cantidad a servir es mayor que cero
             SQL = "SELECT SUM(servidas) as servidas from slipedb WHERE "
...
'Añadir registro en tabla de cabecera de Pedidos: scapedB (Cabecera)
Dim NomTraba As String
    ...
    chkServirCom.Value = 1 'servir completo
...
Private Sub BotonAnyadirLinea(Intercalando As Boolean)
    ...
    txtAux(0).Text = vParamAplic.AlmacenB
...
'Prepara el Form para Modificar la cabecera de Pedidos (tabla: scapedB)
...
'Prepara el Form para Modificar una linea de Pedido (tabla: slipedb)
...
'Eliminar Registro de la Cabecera: Tabla de Pedidos (scapedB)
' y los registros correspondientes de las tablas de lineas (slipedb)
Dim cad As String
    ...
    If MsgBox(cad, vbQuestion + vbYesNo) = vbYes Then
        ...
        If Eliminar() Then PosicionarDataTrasEliminar
    End If
    Screen.MousePointer = vbDefault
...
'Eliminar una linea Del Pedido. (Tabla: slipedb)
Dim SQL As String
...
Dim pos As Integer
    ...
    SQL = "¿Seguro que desea eliminar la línea del pedido presupuesto?     "
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        If ClienteConTasaReciclado Then
            ...
            If ArticuloConTasaReciclado(SQL, ImpReciclado) Then
               ...
               SQL = DevuelveDesdeBD(conAri, "codartic", "slipedb", SQL, CStr(pos))
...
Private Sub Form_Load()
    ...
    'Para que no de error las comprobaciones de error
    Text1(26).visible = False
    Text1(27).visible = False
    Text1(28).visible = False
    
    '## A mano
    chkEnviadaConfir.visible = True  'Not EsHistorico
    Label1(23).visible = True
    Text1(31).visible = True
    
    
    'Quito de la vista los chks de completo, visado y resto de peiddo

'    Me.chkServirCom.Left = 15000
'    Me.chkVisadoRes.Left = 15000
   
     NombreTabla = "scapedB"
     NomTablaLineas = "slipedb" 'Tabla lineas de Pedido
    ...
    If DatosADevolverBusqueda2 = "" Then
        CodTipoMov2 = "-1"
    Else
        CodTipoMov2 = DatosADevolverBusqueda2
    End If
    
    'ASignamos un SQL al DATA1
    Data1.ConnectionString = conn
    Data1.RecordSource = "Select * from " & NombreTabla & " where numpedcl=" & CodTipoMov2
    Data1.Refresh
    ...
    Else
        ...
        End If
    End If
    CodTipoMov2 = "PEZ"  'Pedidos presupuestos
...
Private Function ComprobarOpcionTraspaso(Factura As Boolean) As Boolean
   ...
   'Comprobar que hay un Pedido seleccionado
    ...
    '17 Diciembre 2010
    If EsClienteBloqueado2(Text1(4).Text, 2, False, False) Then Exit Function
...
'''''        AbrirListadoOfer (38) '38: Informe de Pedidos
    ...
    'imprimiremos directo
    With frmImprimir
        .FormulaSeleccion = "{scapedb.numpedcl} = " & Data1.Recordset!NumPedcl
        .OtrosParametros = ""
        .NumeroParametros = 0
        ...
        .NombrePDF = "herpedidob.rpt"
        .NombreRPT = "herpedidob.rpt"
        .ConSubInforme = True
        .Show vbModal
    End With
...
Dim b As Boolean
    ...
    If Modo <> 5 Then Me.lblF.Caption = ""
...
Dim numlinea As String, vWhere As String
    ...
    If DatosOkLinea() Then 'Lineas de Pedidos
        ...
        Else
            ...
            '                                       pongo un 2 por si acaso lleva reclcaje
...
'Modifica un registro en la tabla de lineas de Pedido: slipedb
Dim SQL As String
...
'IN: visible: si es true ponerlos visibles en la posición adecuada
'    limpiar: si es true vaciar los txtAux
'Carga el TxtAux(3) con el campo servidas de la tabla slipedb
Dim alto As Single
...
Dim codCC As String
    ...
    Select Case Index
        ...
        Case 1 'Cod. Articulo
            ...
            If PonerArticulo(txtAux(1), txtAux(2), txtAux(0).Text, CodTipoMov2, ModificaLineas, devuelve, , codCC) Then
...
FinEliminar:
    If Err.Number <> 0 Then
        MuestraError Err.Number, "Eliminar Pedido presupuesto" & vbCrLf & MenError, Err.Description
        b = False
    End If
    If Not b Then
        Eliminar = False
...
'Obtiene la where de la Clave Primaria de la tabla de Cabecera: scapedB
Dim SQL As String
...
'Insertar la Cabecera de un Pedido, tabla: scapedB
Dim MenError As String
...
Dim cambiaSQL As Boolean
    ...
    Do
        ...
        If MenError <> "" Then
            ...
            Existe = True
            vTipoMov.IncrementarContador (CodTipoMov2)
            Text1(0).Text = vTipoMov.ConseguirContador(CodTipoMov2)
            cambiaSQL = True
        Else
            Existe = False
        End If
...
Dim RS As ADODB.Recordset
    ...
    SQL = "SELECT slipedb.codartic, slipedb.numlinea,scapedB.numpedcl, sfamia.instalac "
    SQL = SQL & " FROM ((slipedb INNER JOIN scapedB ON slipedb.numpedcl=scapedB.numpedcl) "
    SQL = SQL & " INNER JOIN sartic ON slipedb.codartic=sartic.codartic) INNER JOIN "
    SQL = SQL & " sfamia ON sartic.codfamia=sfamia.codfamia "
    SQL = SQL & " WHERE scapedB.numpedcl = " & Val(Text1(0).Text) & " And sfamia.instalac = 1"
...
Dim cCli As CCliente
    ...
    If bol Then
        If AlbCompleto Then  'Si se inserta Albaran
            'Borrar el Pedido de las tablas de Pedidos (scapedB, slipedb)
            MenError = "Eliminar pedido."
            bol = EliminarPedido(CLng(Text1(0).Text))
        Else
            'Actualizar la cantidad=cantidad-servidas y servidas= 0 en slipedb
...
'            End If
    ...
    If bol Then
        ...
        If Not AlbCompleto Then
            'Eliminar las filas del pedido que se servieron completas (slipedb)
            SQL = "DELETE FROM slipedb WHERE " & Replace(ObtenerWhereCP, NombreTabla, NomTablaLineas) & " AND cantidad=0"
            conn.Execute SQL
            
            'Comprobar que si no quedan lineas en el pedido se elimine la cabecera del pedido
            SQL = "select codalmac,codartic FROM slipedb WHERE numpedcl=" & Text1(0).Text
            Set RS = New ADODB.Recordset
            RS.Open SQL, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
...
Dim NumBulto As String
    ...
    Else
        ...
        SQL = "select slipedb.*,codprove from slipedb,sartic WHERE  slipedb.codartic=sartic.codartic "
...
'Eliminar las lineas y la Cabecera de un Pedido. Tablas: scapedB, slipedb
Dim SQL As String
...
'Actualiza la tabla de lineas de pedido (slipedb)
...
Dim NumBultos As String
    ...
    SQL = "select codalmac, codartic, cantidad,servidas,numbultos, precioar,dtoline1,dtoline2,numpedcl,numlinea from slipedb "
    SQL = SQL & " WHERE " & Replace(ObtenerWhereCP, NombreTabla, NomTablaLineas)
    Set RS = New ADODB.Recordset
    RS.Open SQL, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    ...
    While Not RS.EOF 'Para cada linea
        ...
        SQL = "UPDATE slipedb SET cantidad=cantidad-servidas, servidas=0, importel=" & DBSet(ImpLinea, "N")
...
Dim SQL As String
    ...
    SQL = "UPDATE scapedB SET restoped=1 " & " WHERE " & ObtenerWhereCP
    conn.Execute SQL
...
Dim SQL As String
    ...
    SQL = "select * from slipedb WHERE " & Replace(ObtenerWhereCP, NombreTabla, NomTablaLineas)
    Set RS = New ADODB.Recordset
    RS.Open SQL, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
...
Dim vTipoM As String
    ...
    '===================================================
    '============ PARAMETROS ===========================
    'If (Opcion = 45) Then indRPT = 29 'Albaran B
    indRPT = 29 'Albaran B
...
'Actualiza el campo "servidas" de la tabla "slipedb"
Dim SQL As String
...
'            sql = TransformaComasPuntos(txtAux(3).Text)
        ...
        End If
    End If
    SQL = "UPDATE slipedb SET servidas= " & SQL
...
Dim vCStock As CStock
    ...
    SePuedeServir = False
    SQL = "SELECT slipedb.codalmac, slipedb.codartic, canstock , sum(servidas), canstock - SUM(servidas) as Dif "
    SQL = SQL & " FROM slipedb INNER JOIN salmac ON slipedb.codalmac=salmac.codalmac AND slipedb.codartic=salmac.codartic "
    SQL = SQL & " WHERE " & Replace(ObtenerWhereCP, NombreTabla, NomTablaLineas) & " AND slipedb.codAlmac = " & Data2.Recordset!codAlmac & " AND slipedb.codartic=" & DBSet(Data2.Recordset!codArtic, "T")
    SQL = SQL & " GROUP by slipedb.codalmac, slipedb.codartic "
...
'        ComprobarNSeriesLineas (NumAlb)
        ...
        If Not PasarTambienAFacturar Then
            If Not ImprimeAlb Then MsgBox "El Pedido de pre. Nº: " & Format(numPed, "0000000") & vbCrLf & vbCrLf & "ha generado el Albaran de Nº: " & Format(NumAlb, "0000000"), vbInformation
        Else
            ...
            'HAY QUE CAMBIAR LA CONEXION DE LA CONTABILIDAD Y QUE APUNTE AL B
            If Not AbrirConexionConta(True) Then
                CadenaSQL = "Error MUY grave." & vbCrLf & "Error conectando con BD: " & vParamAplic.ContabilidadB
                MsgBox CadenaSQL, vbCritical
                End
                Exit Sub
            End If
            CadenaSQL = "scaalb.codtipom = 'ALZ' AND scaalb.numalbar = " & NumAlb
            Precio = "SELECT scaalb.* FROM scaalb INNER JOIN sclien ON scaalb.codclien=sclien.codclien "
            Precio = Precio & " WHERE " & CadenaSQL
            TraspasoAlbaranesFacturas Precio, CadenaSQL, FechaAlb, CtaBancoPropi, Nothing, lblIndicador, ImprimeFactura, "ALZ", "", 1, True, False, False
        ...
        PonerModo 2
        If AlbCompleto Then
            'Se habra eliminado el pedido de (scapedB, slipedb)
            PosicionarDataTrasEliminar
        Else
            SQL = DevuelveDesdeBDNew(conAri, "scapedB", "numpedcl", "numpedcl", Text1(0).Text, "N")
...
Dim RS As ADODB.Recordset
    ...
    If AlbCompleto Then
        SQL = "SELECT codalmac, codartic, SUM(cantidad) as cantidad from slipedb "
    Else
        SQL = "SELECT codalmac, codartic, SUM(servidas) as servidas from slipedb "
    End If
    SQL = SQL & " WHERE " & Replace(ObtenerWhereCP, NombreTabla, NomTablaLineas)
...
'Pone el campo servidas a 0 en la tabla lineas de pedido (slipedb)
Dim SQL As String
...
Dim SQL As String
    ...
    Set vTipoMov = New CTiposMov
    If vTipoMov.Leer(CodTipoMov2) Then
        Text1(0).Text = vTipoMov.ConseguirContador(CodTipoMov2)
...
Dim vFactu As CFactura
    ...
    vFactu.codtipom = CodTipoMov2   'para que pinte CERO el % IVA
...
Dim C As String
    ...
    If N <> Ol Then
        If Ol < 0 Then
            C = "UPDATE scapedB set nomdirec=NULL "
        Else
            C = "UPDATE scapedB SET nomdirec=" & DBSet(Text2(12).Text, "T")
        End If
