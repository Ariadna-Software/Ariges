...
Begin VB.Form frmFacEntOfertas2 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.ComboBox cboOpcion 
         Height          =   315
         ItemData        =   "frmFacEntOfertas.frx":03D3
         Left            =   11160
         List            =   "frmFacEntOfertas.frx":03DD
      ...
      Begin VB.TextBox Text1 
         ...
         Text            =   "frmFacEntOfertas.frx":03E9
         Top             =   3840
         Width           =   9285
      End
      ...
      Begin VB.Frame FrameCliente 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   7
            Left            =   6600
            Picture         =   "frmFacEntOfertas.frx":03F1
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   6
            Left            =   900
            Picture         =   "frmFacEntOfertas.frx":04F3
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   2
            Left            =   6600
            Picture         =   "frmFacEntOfertas.frx":05F5
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   1
            Left            =   900
            Picture         =   "frmFacEntOfertas.frx":06F7
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   5
            Left            =   6600
            Picture         =   "frmFacEntOfertas.frx":07F9
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   4
            Left            =   6600
            Picture         =   "frmFacEntOfertas.frx":08FB
            ToolTipText     =   "Buscar forma de pago"
            Top             =   914
            Width           =   240
         End
      ...
      Begin VB.TextBox Text1 
         ...
         Text            =   "frmFacEntOfertas.frx":09FD
         Top             =   2280
         Width           =   9285
      End
      Begin VB.TextBox Text1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmFacEntOfertas.frx":0A0D
         Height          =   2055
         Left            =   240
         TabIndex        =   59
         Top             =   2880
...
Private Sub Form_Load()
    ...
    If Not EsHistorico Then
        If vUsu.Nivel < 2 Then
            If Val(vUsu.AlmacenPorDefecto) = vParamAplic.AlmacenB Then kCampo = 1
        End If
    End If
...
Dim OrigP As String
    ...
    While Not RN.EOF
        ...
        If RN!origpre <> "M" Then
            ...
            Aux = CPrecioFact.ObtenerPrecio(False, Text1(1).Text, OrigP, "")
            
            If RN!origpre <> OrigP Then Cambiado = "Orig: " & RN!origpre & "-" & OrigP
            
            'Si cambia el precio
            Importe = CCur(Aux)
            If Importe <> RN!precioar Then Cambiado = Cambiado & "  Prec: " & RN!precioar & "-" & Importe
                
                
            'Dtos
            Importe = CCur(CPrecioFact.Descuento1)
            If Importe <> RN!dtoline1 Then Cambiado = Cambiado & "  Dto1: " & RN!dtoline1 & "-" & Importe
            'dto2
            Importe = CCur(CPrecioFact.Descuento2)
            If Importe <> RN!dtoline2 Then Cambiado = Cambiado & "  Dto2: " & RN!dtoline2 & "/" & Importe
