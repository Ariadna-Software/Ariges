...
'                AbrirListado (24) 'OpcionListado=24
                frmInformesNew.OpcionListado = 24 'OpcionListado=1
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Tarifas|900|;S|txtAux(1)|T|Denominación|3350|;S|CboBonifica|C|Bonifica|1100|;"
    '---- Laura: 29/09/06
    tots = tots & "S|txtAux(2)|T|% PVP|1100|;"
    '---- David  21/04/08
    tots = tots & "S|cboPorcentaje|C|Aplica|1100|;"
    '----
