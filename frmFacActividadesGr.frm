...
Begin VB.Form frmFacActividadesGr 
   ...
   ClientTop       =   30
   ClientWidth     =   6630
   Icon            =   "frmFacActividadesGr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7455
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacActividadesGr.frx":000C
      Height          =   5985
      Left            =   135
      TabIndex        =   7
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmFacActividadesGr"
...
Dim SQL As String
    ...
    SQL = DevuelveDesdeBD(conAri, "count(*)", "sclien", "codactiv", CStr(adodc1.Recordset!codactiv))
    If Val(SQL) > 0 Then
        MsgBox "Clientes con esta actividad", vbExclamation
    Else
        SQL = DevuelveDesdeBD(conAri, "count(*)", "sclipot", "codactiv", CStr(adodc1.Recordset!codactiv))
        If Val(SQL) > 0 Then
            MsgBox "Clientes potenciales con esta actividad", vbExclamation
        Else
            SQL = DevuelveDesdeBD(conAri, "count(*)", "sdtofm", "codactiv", CStr(adodc1.Recordset!codactiv))
            If Val(SQL) > 0 Then
                MsgBox "Descuentos familia marca con esta actividad", vbExclamation
            Else
                SQL = "" 'PUEDE SALOR
            End If
        End If
...
Dim tots As String
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Actividad|1000|;S|txtAux(1)|T|Denominación|4630|;"
