...
Begin VB.Form frmListado2 
   ...
   Begin VB.Frame FrameBenxAge 
      ...
      Begin VB.ComboBox cboCoste 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":0722
         Left            =   4320
         List            =   "frmListado2.frx":072F
   ...
   Begin VB.Frame FramePropPedido 
      ...
      Begin VB.ComboBox cboProPed 
         Height          =   315
         Index           =   1
         ItemData        =   "frmListado2.frx":2375
         Left            =   4920
         List            =   "frmListado2.frx":2388
         Style           =   2  'Dropdown List
         TabIndex        =   500
         Top             =   5400
         Width           =   1575
      ...
      Begin VB.ComboBox cboProPed 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":23BA
         Left            =   1560
         List            =   "frmListado2.frx":23C4
         Style           =   2  'Dropdown List
         TabIndex        =   499
         Top             =   5400
         Width           =   1335
   ...
   Begin VB.Frame FrameRecargaMov 
      ...
      Begin VB.ComboBox cmbRecargaMov 
         Height          =   315
         Index           =   1
         ItemData        =   "frmListado2.frx":7C46
         Left            =   3840
         List            =   "frmListado2.frx":7C53
         Style           =   2  'Dropdown List
         TabIndex        =   48
         Top             =   1980
         Width           =   975
      ...
      Begin VB.ComboBox cmbRecargaMov 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":7C66
         Left            =   1800
         List            =   "frmListado2.frx":7C73
         Style           =   2  'Dropdown List
         TabIndex        =   47
         Top             =   1980
         Width           =   975
   ...
   Begin VB.Frame FrameBenClien 
      ...
      Begin VB.ComboBox cboCoste 
         Height          =   315
         Index           =   1
         ItemData        =   "frmListado2.frx":83BC
         Left            =   1440
         List            =   "frmListado2.frx":83C9
         Style           =   2  'Dropdown List
         TabIndex        =   738
         Top             =   4800
         Width           =   1695
   ...
   Begin VB.Frame FrameMultibase 
      ...
      Begin VB.ComboBox cboRoot 
         Height          =   315
         ItemData        =   "frmListado2.frx":8B1B
         Left            =   120
         List            =   "frmListado2.frx":8B28
         Style           =   2  'Dropdown List
         TabIndex        =   758
         Top             =   4800
         Width           =   1815
...
Private Sub cmdCrearCliente_Click()
    ...
    miSQL = "Va a dar de alta el cliente. Desea continuar?"
...
Private Sub cmdInformeProductividad_Click()
    ...
    cadTitulo = ""
    NumRegElim = 0
    For numParam = 0 To 2  'EL de produccion no entra aqui
        If Me.chkInformeProd(numParam).Value = 1 Then
            campo = campo & ", '" & RecuperaValor("ALR|ALE|ALO|", CInt(numParam) + 1) & "'"
            cadTitulo = cadTitulo & "- " & RecuperaValor("Reparación|T. Exterior|Orden Trabajo|", CInt(numParam) + 1)
...
Dim N As Integer
    ...
    If CargarDatosImprimeAlbaranConTransporte Then LlamarImprimir False, N
    If optAlbTrans(0).Value Then
...
Dim IndiceCancel As Integer
    ...
    Case 37, 40
        ...
        Label3(147).Caption = ""
        PonerFrameVisible Me.FrameBenxAge, H, W
        IndiceCancel = 37
    Case 38, 39
        If Opcion = 38 Then
...
Dim Ayuda As String
    ...
    Case 1
        ...
        'Ayuda = Ayuda & "-Si indica valor en ""% mismo cliente"" marcará en el listado los articulos en los cuales " & vbCrLf
...
Dim Kk As Integer
    ...
    While Not miRsAux.EOF
        ...
        'If miRsAux!codArtic = "48HD1/15" Then Stop
...
Private Sub MontaSQLVtasAgente()
    ...
    miSQL = miSQL & " FROM scafac, slifac,sartic,smarca WHERE scafac.codtipom=slifac.codtipom AND"
    ...
    If Me.txtAgente(4).Text <> "" Then miSQL = miSQL & " AND scafac.codagent >= " & DBSet(txtAgente(4).Text, "N")
    If Me.txtAgente(5).Text <> "" Then miSQL = miSQL & " AND scafac.codagent <= " & DBSet(txtAgente(5).Text, "N")
...
Dim Rs As ADODB.Recordset
    ...
    Label3(122).Refresh
    miSQL = "SELECT  distinct(codagent)  "
    ...
    While Not miRsAux.EOF
        ColAgent.Add CStr(miRsAux!CodAgent)
        miRsAux.MoveNext
    Wend
    miRsAux.Close
    ...
    For J = 1 To ColAgent.Count
        ...
        miSQL = "SELECT  sartic.codmarca,scafac.codtipom,importel,dtoppago, dtognral,pvpInferior "
        MontaSQLVtasAgente  'añade los where ....
        miSQL = miSQL & " AND scafac.codagent = " & ColAgent.item(J) & " ORDER BY codmarca"
...
'            End If
        ...
        miSQL = Mid(miSQL, 2)
        miSQL = "INSERT INTO tmpinformes(codusu,codigo1,campo1,campo2,importe1,importe2,importe5,importe3,importe4,importeb1) VALUES " & miSQL
        conn.Execute miSQL
    ...
    If chkResVtaAgen(0).Value Then
            ...
            miSQL = miSQL & " ,SUM(IF(slialb.pvpinferior=2,importel,0)) "
            miSQL = miSQL & " FROM scaalb, slialb,sartic,smarca WHERE scaalb.codtipom=slialb.codtipom AND"
            miSQL = miSQL & " scaalb.NumAlbar = slialb.NumAlbar And slialb.codArtic = sartic.codArtic And "
            miSQL = miSQL & " sartic.codmarca = smarca.codmarca"
            ...
            If Me.txtmarca(4).Text <> "" Then miSQL = miSQL & " AND sartic.codmarca >= " & DBSet(txtmarca(4).Text, "N")
            If Me.txtmarca(5).Text <> "" Then miSQL = miSQL & " AND sartic.codmarca <= " & DBSet(txtmarca(5).Text, "N")
            If Me.txtAgente(4).Text <> "" Then miSQL = miSQL & " AND scaalb.codagent >= " & DBSet(txtAgente(4).Text, "N")
            If Me.txtAgente(5).Text <> "" Then miSQL = miSQL & " AND scaalb.codagent <= " & DBSet(txtAgente(5).Text, "N")
...
Private Sub InsertarTmpBeneAgeProv()
    ...
    miSQL = miSQL & "slifac." & DevuelvePrecioCosteListado(0, True) & ",nomagent,scafac.fecfactu FROM "
    miSQL = miSQL & "scafac,slifac,sartic,sagent  WHERE "
    miSQL = miSQL & " scafac.codtipom=slifac.codtipom and scafac.numfactu=slifac.numfactu and scafac.fecfactu=slifac.fecfactu"
   ...
   campo = "INSERT INTO tmpinformes(codusu,codigo1 ,campo1 , campo2 ,nombre1 ,nombre2 ,importe1 ,importe2 ,importe3 ,nombre3 ,fecha1)  "
   campo = campo & miSQL
   conn.Execute campo
