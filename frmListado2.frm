...
Begin VB.Form frmListado2 
   ...
   Begin VB.Frame FrameBenxAge 
      ...
      Begin VB.ComboBox cboCoste 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":0A79
         Left            =   4320
         List            =   "frmListado2.frx":0A86
         Style           =   2  'Dropdown List
         TabIndex        =   644
         Top             =   5160
         Width           =   1695
   ...
   Begin VB.Frame FrameBeneMarcaAgeProv 
      ...
      Begin VB.ComboBox cboCoste 
         Height          =   315
         Index           =   2
         ItemData        =   "frmListado2.frx":12C6
         Left            =   720
         List            =   "frmListado2.frx":12D3
         Style           =   2  'Dropdown List
         TabIndex        =   867
         Top             =   5520
         Width           =   1695
   ...
   Begin VB.Frame FramePropPedido 
      ...
      Begin VB.ComboBox cboProPed 
         Height          =   315
         Index           =   1
         ItemData        =   "frmListado2.frx":234B
         Left            =   4920
         List            =   "frmListado2.frx":235E
         Style           =   2  'Dropdown List
         TabIndex        =   500
         Top             =   5400
         Width           =   1575
      ...
      Begin VB.ComboBox cboProPed 
         Height          =   315
         Index           =   0
         ItemData        =   "frmListado2.frx":2390
         Left            =   1560
         List            =   "frmListado2.frx":239A
         Style           =   2  'Dropdown List
         TabIndex        =   499
         Top             =   5400
         Width           =   1335
