...
Begin VB.Form frmVariosNew 
   ...
   Begin VB.Frame FrameHcoAlmacen 
      ...
      Begin VB.Label lblTitulo 
         Caption         =   "Seleccionar Movimientos Almacén"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   14.25
            Charset         =   0
...
Dim IndexOpcion As Integer
    ...
    Case 100, 101
        ...
        lblInd(3).Caption = ""
        If Opcion = 100 Then
            lblTitulo(18).Caption = "Seleccionar Traspaso de Almacén"
        End If
...
Dim IT As ListItem
    ...
    If Opcion = 101 Then
        ListView6.ColumnHeaders.Add , , "NºMovim.", 1150
        ListView6.ColumnHeaders.Add , , "Fecha", 1450, 0
        ListView6.ColumnHeaders.Add , , "Hora", 1100, 0
        ListView6.ColumnHeaders.Add , , "Código", 900, 0
        ...
        ListView7.ColumnHeaders.Add , , "Artículo", 1200
        ListView7.ColumnHeaders.Add , , "Nombre", 3500, 0
        ListView7.ColumnHeaders.Add , , "Cantidad", 1500, 2
        ListView7.ColumnHeaders.Add , , "Situación", 1200, 0
