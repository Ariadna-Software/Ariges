...
Begin VB.Form frmListado5 
      ...
      Begin MSComctlLib.ImageList imglistPed 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmListado5.frx":6862
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmListado5.frx":D0C4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame FrameListadoAlb 
      ...
      Begin VB.ComboBox cboDestinoB 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmListado5.frx":1AF5B
         Left            =   840
         List            =   "frmListado5.frx":1AF62
...
Private Sub cmdTaxcoNuevoEntradaVehiculo_Click()
    ...
    If lw(8).ListItems.Count > 1 Then
        If lw(8).ListItems(1).Tag <> lw(8).SelectedItem.Tag Then Exit Sub
    End If
...
Dim Importe As Currency
    ...
    auxiliar = auxiliar & " AND  scaalb.codforpa=2 GROUP BY codclien ORDER BY codclien"
    miRsAux.Open auxiliar, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    auxiliar = ""
    miSQL = ""
    While Not miRsAux.EOF
    ...
    auxiliar = "delete  from tmpinformes where codusu = " & vUsu.Codigo
    auxiliar = auxiliar & " and nombre2  IN (select codmacta from ariconta1.cuentas where apudirec='S' and codmacta like '4301%')"
    conn.Execute auxiliar
    Espera 0.5
