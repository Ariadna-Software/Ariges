...
Begin VB.Form frmProdEnvas 
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button12 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Cerrar // abrir "
         EndProperty
   ...
   Begin VB.Menu mnOpciones 
      ...
      Begin VB.Menu mnDeshacerCierre 
         Caption         =   "Deshacer cierre envasado"
      End
...
'        SituarDataTrasEliminar Data2, NumRegElim
        ...
        If Data2.Recordset.EOF Then CargaGrid3 False
'        CancelaADODC
    End If
...
Private Sub mnDeshacerCierre_Click()
    ...
    If MsgBox("¿Seguro que desea abrir la orden de envasado?", vbQuestion + vbYesNoCancel) <> vbYes Then Exit Sub
    ...
    Else
        ...
        If AccionDeshaceCierreProd() Then
            ...
            davidCodtipom = "GROUP_CONCAT( concat(slienvpr.codartic,' - ',nomartic) separator '\n')"
            davidCodtipom = DevuelveDesdeBD(conAri, davidCodtipom, "slienvpr left join sartic on slienvpr.codartic=sartic.codartic ", "codigo  ", Data1.Recordset!Codigo & " GROUP BY codigo")
            CadenaDesdeOtroForm = "Envasado nº" & Data1.Recordset!Codigo & "    Cierre : " & Data1.Recordset!fecproduccion
            CadenaDesdeOtroForm = CadenaDesdeOtroForm & vbCrLf & davidCodtipom & vbCrLf
            
            davidCodtipom = "GROUP_CONCAT( concat(slienvpr2.codarti2,' - ',nomartic) separator '\n') "
            davidCodtipom = DevuelveDesdeBD(conAri, davidCodtipom, " slienvpr2 left join sartic on slienvpr2.codarti2=sartic.codartic ", "codigo  ", Data1.Recordset!Codigo & " GROUP BY codigo")
        ...
        Case 12, 14
            ...
            If ButtonIndex = 12 Then
                ...
                If Not IsNull(Data1.Recordset!fecproduccion) Then
                    ...
                    If CadenaConsulta = "" Then CadenaConsulta = "OK" 'refresca data1.
                Else
...
Dim Sql As String
    ...
    If DatosOkLineaCompo() Then 'Lineas de Pedidos
        ...
        Sql = DevuelveDesdeBD(conAri, "max(numlinea)", "slienvpr2", Sql, Data1.Recordset!Codigo, "N")
        If Sql = "" Then Sql = "0"
...
Dim Sql As String
    ...
    Sql = " Select codarti2,nomartic,numlote,slienvpr2.codprove,nomprove,cantidad,numlinea  from " & Sql
...
Dim RN As ADODB.Recordset
    ...
    If Not LoteEncontrado Then
            ...
            If Data2.Recordset.EOF Then
                Sql = "N"
            Else
                If Data3.Recordset.EOF Then Sql = "N"
            End If
...
Private Function ComprobarFechasInventario() As Boolean
    ...
    For NumRegElim = 1 To 2
        ...
        davidCodtipom = davidCodtipom & " select codalmac,XXXXX FROM slienvprNNNNN"
        ...
        davidCodtipom = davidCodtipom & " where codigo =" & Data1.Recordset!Codigo & ")"
...
On Error GoTo eAccionDeshaceCierreProd
    ...
    'Data1.Recordset
    Sql = "UPDATE salmac, slienvpr,sartic Set CanStock = CanStock - cantidad"
    Sql = Sql & " WHERE slienvpr.codigo = " & CStr(Data1.Recordset!Codigo)
    Sql = Sql & " AND     salmac.codalmac = 1 AND salmac.codartic = slienvpr.codartic AND salmac.codartic = sartic.codartic AND ctrstock=1;"
    conn.Execute Sql
      
    Sql = " UPDATE salmac, slienvpr2,sartic Set CanStock = CanStock + cantidad"
    Sql = Sql & " WHERE slienvpr2.codigo =" & CStr(Data1.Recordset!Codigo)
    Sql = Sql & " AND salmac.codalmac = 1 AND  salmac.codartic = slienvpr2.codarti2 AND salmac.codartic = sartic.codartic AND ctrstock=1;"
    conn.Execute Sql

    Sql = "DELETE FROM smoval WHERE document = '" & CStr(Data1.Recordset!Codigo) & "' AND detamovi = 'PRE'"
    conn.Execute Sql
    
    Sql = "UPDATE senvprod SET fecproduccion = NULL WHERE codigo = " & CStr(Data1.Recordset!Codigo)
    conn.Execute Sql
