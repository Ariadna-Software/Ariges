...
Begin VB.Form frmAlmagrupo 
   ...
   Begin VB.TextBox Text1 
      ...
      Left            =   120
      TabIndex        =   0
      Tag             =   "Año|N|N|1900|2200|salmagrupo|anyo|00|S|"
      Text            =   "Text1"
      Top             =   840
      Width           =   765
   End
...
Private Sub BotonAnyadir()
    If MsgBox("No deberia insertar los consumos por aquí. ¿Continuar?", vbQuestion + vbYesNo) = vbNo Then Exit Sub
    LimpiarCampos
    PonerModo 3
...
Private Sub BotonEliminar()
    ...
    If Data1.Recordset.EOF Then Exit Sub
        ...
        CadenaConsulta2 = CadenaConsulta2 & vbCrLf & "Descripción: " & Text3(2).Text
