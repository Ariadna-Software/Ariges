...
Dim Cad As String
    ...
    If LineasArticulosEnPedidosProveedor <> "" Then
        ...
        txtAnterior = vbCrLf & Cad & vbCrLf & "Hay articulos en pedido de proveeddor" & vbCrLf & LineasArticulosEnPedidosProveedor & vbCrLf & Cad
    End If
...
'Avanzar/Retroceder los campos con las flechas de desplazamiento del teclado.
      If Index <> 33 Then KEYdown KeyCode
    ...
    While Not RS.EOF 'Para cada linea de pedido insertar una de albaran si servidas >0
        ...
        If CompruebaLinea Then
                ...
                Else
                    ...
                    'SQ = CPrecioFact.ObtenerPrecio(SQ = "", Text1(1).Text, "")
                    LlevaDtoEspecial = ""
