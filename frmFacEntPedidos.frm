...
Begin VB.Form frmFacEntPedidos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame FrameCliente 
         ...
         Begin VB.Image imgCerrado 
            Height          =   480
            Left            =   5400
            Picture         =   "frmFacEntPedidos.frx":6E0D
            Stretch         =   -1  'True
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   9
            Left            =   7350
            Picture         =   "frmFacEntPedidos.frx":7550
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   6
            Left            =   900
            Picture         =   "frmFacEntPedidos.frx":7652
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   2
            Left            =   7350
            Picture         =   "frmFacEntPedidos.frx":7754
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   1
            Left            =   900
            Picture         =   "frmFacEntPedidos.frx":7856
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   5
            Left            =   7350
            Picture         =   "frmFacEntPedidos.frx":7958
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   4
            Left            =   7350
            Picture         =   "frmFacEntPedidos.frx":7A5A
            ToolTipText     =   "Buscar forma de pago"
            Top             =   900
            Width           =   240
         End
         ...
         Begin VB.Image imgEstado 
            ...
            Index           =   2
            Left            =   7920
            Picture         =   "frmFacEntPedidos.frx":7B5C
            ToolTipText     =   "CERRADO"
            Top             =   1920
            Visible         =   0   'False
            Width           =   240
         ...
         Begin VB.Image imgEstado 
            ...
            Index           =   0
            Left            =   7920
            Picture         =   "frmFacEntPedidos.frx":95CE
            ToolTipText     =   "Abierto"
            Top             =   1920
            Visible         =   0   'False
            Width           =   240
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmFacEntPedidos.frx":FE20
         Height          =   2760
         Left            =   195
         TabIndex        =   59
         Top             =   2760
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   11
         Left            =   -64320
         Picture         =   "frmFacEntPedidos.frx":FE35
         ToolTipText     =   "Buscar forma de pago"
         Top             =   1440
         Width           =   240
      End
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   10
      Left            =   3240
      Picture         =   "frmFacEntPedidos.frx":FF37
      ToolTipText     =   "Buscar cliente varios"
      Top             =   7080
      Width           =   240
   End
...
Dim Port As Integer      'Port: para saber si ha metido/Modificado el articulo de portes
    ...
    If Modo = 5 Then  'modo 5: Mantenimientos Lineas
        ...
        'Herbelca
        If vParamAplic.NumeroInstalacion = vbHerbelca Then
            If Me.chkEnviadaConfir.Value = 0 Then
                Cad = "sliped.codartic=sartic.codartic AND rotacion=0 AND numpedcl"
                Cad = DevuelveDesdeBD(conAri, "count(*)", "sliped,sartic", Cad, Text1(0).Text)
                If Val(Cad) >= 1 Then
                    mnConfirmacion_Click
                    Cad = DevuelveDesdeBD(conAri, "envconfir", "scaped ", "numpedcl", Text1(0).Text)
                    chkEnviadaConfir.Value = IIf(Cad = "1", 1, 0)
                End If
            End If
        End If
...
Private Sub DataGrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    If Modo = 2 Or (Modo = 5 And ModificaLineas = 0) Then
        If KeyCode = 113 Then Text1_KeyDown 0, KeyCode, 0
    End If
End Sub
...
'        End If
        If vParamAplic.NumeroInstalacion = vbFontenas Then
            .Buttons(15).Image = 55  'tiene que ser 55
            .Buttons(15).ToolTipText = "Importar pedido EXCEL"
        End If
...
Dim CambiaZona As Boolean
    ...
    vSQL = DevuelveDesdeBD(conAri, "marcafacturar", "sclien", "codclien", Text1(4).Text) 'mfacturar S/N
    CambiaZona = vSQL = "1"
    ...
    vSQL = vSQL & CStr(Abs(CambiaZona))   ' CStr(Abs(vParamAplic.MarcarAlbaranFacturar))
   ...
   If Not ComprobarOpcionTraspaso(True) Then Exit Sub
    ...
    Else
        ...
        If B = 1 Then
            ...
            If MsgBox(TituloLinea, vbYesNo + vbQuestion, "Contol de Stock") = vbYes Then
                frmMensajes.cadWhere = " WHERE numpedcl = " & Text1(0).Text & " And sfamia.instalac = 0 "
                frmMensajes.vCampos = NomTablaLineas
                frmMensajes.OpcionMensaje = 2 'Articulos sin Stock
                frmMensajes.Show vbModal
...
'Avanzar/Retroceder los campos con las flechas de desplazamiento del teclado.
    ...
    Else
        If KeyCode = 113 Then
            If Modo = 2 Or (Modo = 5 And ModificaLineas = 0) Then
                If Not Data2.Recordset.EOF Then
                    txtAux(1).Text = Me.Data2.Recordset!codArtic
                    AccionesF2 3
                    txtAux(1).Text = ""
                End If
            End If
        ...
        Case 1 'Cod. Articulo
            ...
            If PonerArticulo(txtAux(1), txtAux(2), txtAux(0).Text, CodTipoMov, ModificaLineas, devuelve, , codCC, StatusArticMayorCero) Then
                ...
                If devuelve <> txtAux(1).Text Then
                    ...
                    'Si NO es de varios reestablecemos
                    ...
                    Else
                        ...
                        'Nov 2021
                        'En herbelca , si esta modificando linea de articulo, entonces "SOLO" cambia el codartic
                        If vParamAplic.NumeroInstalacion = vbHerbelca Then
                            If ModificaLineas = 2 Then txtAux(2).Text = Data2.Recordset!NomArtic
                        End If
                    End If
                End If
...
Dim vTipoM As String
    ...
    If TieneNumerosDeSerie And vParamAplic.NumeroInstalacion = vbHerbelca Then
            ...
            devuelve = DevuelveDesdeBD(conAri, "count(*)", devuelve, "codtipom = '" & vTipoM & "' AND numalbar = " & Numalbar & " and impresionauxiliar", "1")
            If devuelve = "" Then devuelve = 0
...
Dim IMporteTicketExcede As Boolean
    ...
    If PasarTambienAFacturar And vParamAplic.SerieFacturaDirecta <> "" Then
        ...
        Else
            If Comprobar_NIF(Text1(6).Text) Then
                ...
                IMporteTicketExcede = True   'hace FAD
            Else
    ...
    frmList.FacturaSuperaImporteTicket = False
...
'        ComprobarNSeriesLineas (NumAlb)
        ...
        Else
            ...
            If IMporteTicketExcede Then
                If EsAMostrador2 = 1 Then
                    'OK. Cambia la serie de factura
                Else
                    IMporteTicketExcede = False 'No teien que hacer factura directa
                End If
            End If
            ...
            TraspasoAlbaranesFacturas Precio, CadenaSQL, FechaAlb, CtaBancoPropi, Nothing, lblIndicador, ImprimeFactura, Sql, "", 1, True, False, False, IMporteTicketExcede
        End If
...
Dim mi As String
    ...
    If b2 = 0 And vParamAplic.NumeroInstalacion = vbHerbelca Then
        mi = ""
        If AlbCompleto Then
                    ...
                    If Rs!canti <> 0 Then
                        ...
                        If Rs!origpre <> "E" Then
                            ...
                            If vAr.EstablecidoPrecioMinimo Then
                                ...
                                If vAr.PrecioMinimo - PrMinimo > 0.009 Then mi = mi & vbCrLf & vAr.Codigo & "  - " & vAr.Nombre & "  (" & vAr.PrecioMinimo & " // " & PrMinimo & ")"
