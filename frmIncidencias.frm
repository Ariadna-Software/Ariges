...
Private frmInf As frmInformesNew
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 8: 'ImprimirInci
                ...
                Set frmInf = New frmInformesNew
                frmInf.OpcionListado = 999
                frmInf.Show vbModal
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Denominación|4630|;"
